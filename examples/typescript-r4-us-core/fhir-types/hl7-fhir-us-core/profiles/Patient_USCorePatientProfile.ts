...
export class USCorePatientProfile {
    ...
    public getRace(mode: 'valid-flat'): USCorePatientProfile_RaceValidFlat | undefined;
    ...
    public getRace (mode: 'flat' | 'valid-flat' | 'profile' | 'raw' = 'flat'): USCorePatientProfile_RaceExtracted | USCorePatientProfile_RaceValidFlat | USCoreRaceExtensionProfile | Extension | undefined {
        ...
        if (mode === 'valid-flat') {
            ...
            if (errors.length > 0) throw new Error(errors.join("; "))
            return extractComplexExtension<USCorePatientProfile_RaceValidFlat>(ext, config)
        }
    ...
    public getEthnicity(mode: 'valid-flat'): USCorePatientProfile_EthnicityValidFlat | undefined;
    ...
    public getEthnicity (mode: 'flat' | 'valid-flat' | 'profile' | 'raw' = 'flat'): USCorePatientProfile_EthnicityExtracted | USCorePatientProfile_EthnicityValidFlat | USCoreEthnicityExtensionProfile | Extension | undefined {
        ...
        if (mode === 'valid-flat') {
            ...
            if (errors.length > 0) throw new Error(errors.join("; "))
            return extractComplexExtension<USCorePatientProfile_EthnicityValidFlat>(ext, config)
        }
    ...
    public getTribalAffiliation(mode: 'valid-flat'): USCorePatientProfile_TribalAffiliationValidFlat | undefined;
    ...
    public getTribalAffiliation (mode: 'flat' | 'valid-flat' | 'profile' | 'raw' = 'flat'): USCorePatientProfile_TribalAffiliationExtracted | USCorePatientProfile_TribalAffiliationValidFlat | USCoreTribalAffiliationExtensionProfile | Extension | undefined {
        ...
        if (mode === 'valid-flat') {
            ...
            if (errors.length > 0) throw new Error(errors.join("; "))
            return extractComplexExtension<USCorePatientProfile_TribalAffiliationValidFlat>(ext, config)
        }
