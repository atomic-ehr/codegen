...
export class USCorePatientProfile {
    ...
    public getRace(mode: 'flat'): Partial<Pick<USCoreRaceExtensionProfileFlat, "ombCategory" | "detailed" | "text">> | undefined;
    public getRace(mode: 'profile'): USCoreRaceExtensionProfile | undefined;
    public getRace(mode: 'raw'): Extension | undefined;
    public getRace(): Partial<Pick<USCoreRaceExtensionProfileFlat, "ombCategory" | "detailed" | "text">> | undefined;
    public getRace (mode: 'flat' | 'profile' | 'raw' = 'flat'): Partial<Pick<USCoreRaceExtensionProfileFlat, "ombCategory" | "detailed" | "text">> | USCoreRaceExtensionProfile | Extension | undefined {
        ...
        return extractComplexExtension<Partial<Pick<USCoreRaceExtensionProfileFlat, "ombCategory" | "detailed" | "text">>>(ext, config)
    }
    ...
    public getEthnicity(mode: 'flat'): Partial<Pick<USCoreEthnicityExtensionProfileFlat, "ombCategory" | "detailed" | "text">> | undefined;
    ...
    public getEthnicity(): Partial<Pick<USCoreEthnicityExtensionProfileFlat, "ombCategory" | "detailed" | "text">> | undefined;
    public getEthnicity (mode: 'flat' | 'profile' | 'raw' = 'flat'): Partial<Pick<USCoreEthnicityExtensionProfileFlat, "ombCategory" | "detailed" | "text">> | USCoreEthnicityExtensionProfile | Extension | undefined {
        ...
        const config = [{ name: "ombCategory", valueField: "valueCoding", isArray: false }, { name: "detailed", valueField: "valueCoding", isArray: true }, { name: "text", valueField: "valueString", isArray: false }]
        return extractComplexExtension<Partial<Pick<USCoreEthnicityExtensionProfileFlat, "ombCategory" | "detailed" | "text">>>(ext, config)
    }
    ...
    public getTribalAffiliation(mode: 'flat'): Partial<Pick<USCoreTribalAffiliationExtensionProfileFlat, "tribalAffiliation" | "isEnrolled">> | undefined;
    ...
    public getTribalAffiliation(): Partial<Pick<USCoreTribalAffiliationExtensionProfileFlat, "tribalAffiliation" | "isEnrolled">> | undefined;
    public getTribalAffiliation (mode: 'flat' | 'profile' | 'raw' = 'flat'): Partial<Pick<USCoreTribalAffiliationExtensionProfileFlat, "tribalAffiliation" | "isEnrolled">> | USCoreTribalAffiliationExtensionProfile | Extension | undefined {
        ...
        return extractComplexExtension<Partial<Pick<USCoreTribalAffiliationExtensionProfileFlat, "tribalAffiliation" | "isEnrolled">>>(ext, config)
    }
