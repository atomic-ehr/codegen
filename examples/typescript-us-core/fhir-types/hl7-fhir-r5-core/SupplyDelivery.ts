...
export interface SupplyDeliverySuppliedItem extends BackboneElement {
    ...
    itemReference?: Reference<"BiologicallyDerivedProduct" | "Device" | "InventoryItem" | "Medication" | "NutritionProduct" | "Substance">;
    quantity?: Quantity;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/SupplyDelivery (pkg: hl7.fhir.r5.core#5.0.0)
