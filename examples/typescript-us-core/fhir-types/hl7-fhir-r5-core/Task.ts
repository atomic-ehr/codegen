...
export interface TaskPerformer extends BackboneElement {
    actor: Reference<"CareTeam" | "Organization" | "Patient" | "Practitioner" | "PractitionerRole" | "RelatedPerson">;
...
// CanonicalURL: http://hl7.org/fhir/StructureDefinition/Task (pkg: hl7.fhir.r5.core#5.0.0)
export interface Task extends DomainResource {
    ...
    note?: Annotation[];
    output?: TaskOutput[];
    owner?: Reference<"CareTeam" | "Organization" | "Patient" | "Practitioner" | "PractitionerRole" | "RelatedPerson">;
