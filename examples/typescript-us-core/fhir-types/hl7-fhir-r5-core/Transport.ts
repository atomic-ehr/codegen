...
export const isTransport = (resource: unknown): resource is Transport => {
    return resource !== null && typeof resource === "object" && (resource as {resourceType: string}).resourceType === "Transport";
}
