...
export interface Observationbodyheight extends Observation {
...
export type Observationbodyheight_Category_VSCatSliceInput = Omit<CodeableConcept, "coding">;
...
export type ObservationbodyheightProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"Patient">;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/bodyheight (pkg: hl7.fhir.r5.core#5.0.0)
export class ObservationbodyheightProfile {
    ...
    constructor (resource: Observation) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/StructureDefinition/bodyheight")) profiles.push("http://hl7.org/fhir/StructureDefinition/bodyheight")
    }

    static from (resource: Observation) : ObservationbodyheightProfile {
        return new ObservationbodyheightProfile(resource)
    }

    static createResource (args: ObservationbodyheightProfileParams) : Observation {
    ...
    static create (args: ObservationbodyheightProfileParams) : ObservationbodyheightProfile {
        return ObservationbodyheightProfile.from(ObservationbodyheightProfile.createResource(args))
    }
    ...
    toProfile () : Observationbodyheight {
        return this.resource as Observationbodyheight
    }

    public setVscat (input?: Observationbodyheight_Category_VSCatSliceInput): this {
    ...
    public getVscat (): Observationbodyheight_Category_VSCatSliceInput | undefined {
        const match = {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}} as Record<string, unknown>
        const list = this.resource.category
        if (!list) return undefined
        const item = list.find((item) => matchesSlice(item, match))
        if (!item) return undefined
        return extractSliceSimplified(item as unknown as Record<string, unknown>, ["coding"]) as Observationbodyheight_Category_VSCatSliceInput
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "Observationbodyheight"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "Observationbodyheight"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "Observationbodyheight"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "Observationbodyheight.category"))
        { const e = validateRequired(r, "code", "Observationbodyheight"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"code":"8302-2","system":"http://loinc.org"}]}, "Observationbodyheight"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "Observationbodyheight"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["Patient"], "subject", "Observationbodyheight"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","Observationvitalsigns"], "hasMember", "Observationbodyheight"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","MolecularSequence","QuestionnaireResponse","Observationvitalsigns"], "derivedFrom", "Observationbodyheight"); if (e) errors.push(e) }
        return errors
    }
