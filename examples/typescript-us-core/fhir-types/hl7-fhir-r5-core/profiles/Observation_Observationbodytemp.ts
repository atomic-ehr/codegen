...
export interface Observationbodytemp extends Observation {
...
export type Observationbodytemp_Category_VSCatSliceInput = Omit<CodeableConcept, "coding">;
...
export type ObservationbodytempProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"Patient">;
    category?: CodeableConcept<("social-history" | "vital-signs" | "imaging" | "laboratory" | "procedure" | "survey" | "exam" | "therapy" | "activity" | string)>[];
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/bodytemp (pkg: hl7.fhir.r5.core#5.0.0)
export class ObservationbodytempProfile {
    ...
    constructor (resource: Observation) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/StructureDefinition/bodytemp")) profiles.push("http://hl7.org/fhir/StructureDefinition/bodytemp")
    }

    static from (resource: Observation) : ObservationbodytempProfile {
        return new ObservationbodytempProfile(resource)
    }

    static createResource (args: ObservationbodytempProfileParams) : Observation {
    ...
    static create (args: ObservationbodytempProfileParams) : ObservationbodytempProfile {
        return ObservationbodytempProfile.from(ObservationbodytempProfile.createResource(args))
    }
    ...
    toProfile () : Observationbodytemp {
        return this.resource as Observationbodytemp
    }

    public setVSCat (input?: Observationbodytemp_Category_VSCatSliceInput): this {
    ...
    public getVSCat (): Observationbodytemp_Category_VSCatSliceInput | undefined {
        const match = {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}} as Record<string, unknown>
        const list = this.resource.category
        if (!list) return undefined
        const item = list.find((item) => matchesSlice(item, match))
        if (!item) return undefined
        return extractSliceSimplified(item as unknown as Record<string, unknown>, ["coding"]) as Observationbodytemp_Category_VSCatSliceInput
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "Observationbodytemp"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "Observationbodytemp"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "Observationbodytemp"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "Observationbodytemp.category"))
        { const e = validateRequired(r, "code", "Observationbodytemp"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"code":"8310-5","system":"http://loinc.org"}]}, "Observationbodytemp"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "Observationbodytemp"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["Patient"], "subject", "Observationbodytemp"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","Observationvitalsigns"], "hasMember", "Observationbodytemp"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","MolecularSequence","QuestionnaireResponse","Observationvitalsigns"], "derivedFrom", "Observationbodytemp"); if (e) errors.push(e) }
        return errors
    }
