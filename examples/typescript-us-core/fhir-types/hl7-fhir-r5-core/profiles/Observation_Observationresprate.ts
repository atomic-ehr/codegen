...
export interface Observationresprate extends Observation {
...
export type Observationresprate_Category_VSCatSliceInput = Omit<CodeableConcept, "coding">;
...
export type ObservationresprateProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"Patient">;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/resprate (pkg: hl7.fhir.r5.core#5.0.0)
export class ObservationresprateProfile {
    ...
    constructor (resource: Observation) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/StructureDefinition/resprate")) profiles.push("http://hl7.org/fhir/StructureDefinition/resprate")
    }

    static from (resource: Observation) : ObservationresprateProfile {
        return new ObservationresprateProfile(resource)
    }

    static createResource (args: ObservationresprateProfileParams) : Observation {
    ...
    static create (args: ObservationresprateProfileParams) : ObservationresprateProfile {
        return ObservationresprateProfile.from(ObservationresprateProfile.createResource(args))
    }
    ...
    toProfile () : Observationresprate {
        return this.resource as Observationresprate
    }

    public setVscat (input?: Observationresprate_Category_VSCatSliceInput): this {
    ...
    public getVscat (): Observationresprate_Category_VSCatSliceInput | undefined {
        const match = {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}} as Record<string, unknown>
        const list = this.resource.category
        if (!list) return undefined
        const item = list.find((item) => matchesSlice(item, match))
        if (!item) return undefined
        return extractSliceSimplified(item as unknown as Record<string, unknown>, ["coding"]) as Observationresprate_Category_VSCatSliceInput
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "Observationresprate"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "Observationresprate"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "Observationresprate"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "Observationresprate.category"))
        { const e = validateRequired(r, "code", "Observationresprate"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"code":"9279-1","system":"http://loinc.org"}]}, "Observationresprate"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "Observationresprate"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["Patient"], "subject", "Observationresprate"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","Observationvitalsigns"], "hasMember", "Observationresprate"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","MolecularSequence","QuestionnaireResponse","Observationvitalsigns"], "derivedFrom", "Observationresprate"); if (e) errors.push(e) }
        return errors
    }
