...
export type ObservationvitalsignsProfileParams = {
...
// CanonicalURL: http://hl7.org/fhir/StructureDefinition/vitalsigns (pkg: hl7.fhir.r5.core#5.0.0)
export class ObservationvitalsignsProfile {
    ...
    static from (resource: Observation) : ObservationvitalsignsProfile {
        return new ObservationvitalsignsProfile(resource)
    }

    static createResource (args: ObservationvitalsignsProfileParams) : Observation {
    ...
    static create (args: ObservationvitalsignsProfileParams) : ObservationvitalsignsProfile {
        return ObservationvitalsignsProfile.from(ObservationvitalsignsProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "Observationvitalsigns"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "Observationvitalsigns"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "Observationvitalsigns"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "Observationvitalsigns.category"))
        { const e = validateRequired(r, "code", "Observationvitalsigns"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "Observationvitalsigns"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["Patient"], "subject", "Observationvitalsigns"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","Observationvitalsigns"], "hasMember", "Observationvitalsigns"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","MolecularSequence","QuestionnaireResponse","Observationvitalsigns"], "derivedFrom", "Observationvitalsigns"); if (e) errors.push(e) }
        return errors
    }
