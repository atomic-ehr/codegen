...
export class ObservationbpProfile {
    ...
    public getVscat(raw?: false): Observationbp_Category_VSCatSliceInput | undefined
    public getVscat (raw?: boolean): CodeableConcept | Observationbp_Category_VSCatSliceInput | undefined {
        const match = {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}} as Record<string, unknown>
        const list = this.resource.category
