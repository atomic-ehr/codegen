...
export interface Observationheartrate extends Observation {
...
export type Observationheartrate_Category_VSCatSliceInput = Omit<CodeableConcept, "coding">;
...
export type ObservationheartrateProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"Patient">;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/heartrate (pkg: hl7.fhir.r5.core#5.0.0)
export class ObservationheartrateProfile {
    ...
    constructor (resource: Observation) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/StructureDefinition/heartrate")) profiles.push("http://hl7.org/fhir/StructureDefinition/heartrate")
    }

    static from (resource: Observation) : ObservationheartrateProfile {
        return new ObservationheartrateProfile(resource)
    }

    static createResource (args: ObservationheartrateProfileParams) : Observation {
    ...
    static create (args: ObservationheartrateProfileParams) : ObservationheartrateProfile {
        return ObservationheartrateProfile.from(ObservationheartrateProfile.createResource(args))
    }
    ...
    toProfile () : Observationheartrate {
        return this.resource as Observationheartrate
    }

    public setVscat (input?: Observationheartrate_Category_VSCatSliceInput): this {
    ...
    public getVscat (): Observationheartrate_Category_VSCatSliceInput | undefined {
        const match = {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}} as Record<string, unknown>
        const list = this.resource.category
        if (!list) return undefined
        const item = list.find((item) => matchesSlice(item, match))
        if (!item) return undefined
        return extractSliceSimplified(item as unknown as Record<string, unknown>, ["coding"]) as Observationheartrate_Category_VSCatSliceInput
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "Observationheartrate"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "Observationheartrate"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "Observationheartrate"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "Observationheartrate.category"))
        { const e = validateRequired(r, "code", "Observationheartrate"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"code":"8867-4","system":"http://loinc.org"}]}, "Observationheartrate"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "Observationheartrate"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["Patient"], "subject", "Observationheartrate"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","Observationvitalsigns"], "hasMember", "Observationheartrate"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","MolecularSequence","QuestionnaireResponse","Observationvitalsigns"], "derivedFrom", "Observationheartrate"); if (e) errors.push(e) }
        return errors
    }
