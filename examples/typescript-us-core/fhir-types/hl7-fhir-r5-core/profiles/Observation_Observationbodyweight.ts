...
export interface Observationbodyweight extends Observation {
...
export type Observationbodyweight_Category_VSCatSliceInput = Omit<CodeableConcept, "coding">;
...
export type ObservationbodyweightProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"Patient">;
    category?: CodeableConcept<("social-history" | "vital-signs" | "imaging" | "laboratory" | "procedure" | "survey" | "exam" | "therapy" | "activity" | string)>[];
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/bodyweight (pkg: hl7.fhir.r5.core#5.0.0)
export class ObservationbodyweightProfile {
    ...
    static from (resource: Observation) : ObservationbodyweightProfile {
        return new ObservationbodyweightProfile(resource)
    }

    static createResource (args: ObservationbodyweightProfileParams) : Observation {
    ...
    static create (args: ObservationbodyweightProfileParams) : ObservationbodyweightProfile {
        return ObservationbodyweightProfile.from(ObservationbodyweightProfile.createResource(args))
    }
    ...
    toProfile () : Observationbodyweight {
        return this.resource as Observationbodyweight
    }

    public setVSCat (input?: Observationbodyweight_Category_VSCatSliceInput): this {
    ...
    public getVSCat (): Observationbodyweight_Category_VSCatSliceInput | undefined {
        const match = {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}} as Record<string, unknown>
        const list = this.resource.category
        if (!list) return undefined
        const item = list.find((item) => matchesSlice(item, match))
        if (!item) return undefined
        return extractSliceSimplified(item as unknown as Record<string, unknown>, ["coding"]) as Observationbodyweight_Category_VSCatSliceInput
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "Observationbodyweight"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "Observationbodyweight"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "Observationbodyweight"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "Observationbodyweight.category"))
        { const e = validateRequired(r, "code", "Observationbodyweight"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"code":"29463-7","system":"http://loinc.org"}]}, "Observationbodyweight"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "Observationbodyweight"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["Patient"], "subject", "Observationbodyweight"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","Observationvitalsigns"], "hasMember", "Observationbodyweight"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","MolecularSequence","QuestionnaireResponse","Observationvitalsigns"], "derivedFrom", "Observationbodyweight"); if (e) errors.push(e) }
        return errors
    }
