...
export interface Observationbmi extends Observation {
...
export type Observationbmi_Category_VSCatSliceInput = Omit<CodeableConcept, "coding">;
...
export type ObservationbmiProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"Patient">;
    category?: CodeableConcept<("social-history" | "vital-signs" | "imaging" | "laboratory" | "procedure" | "survey" | "exam" | "therapy" | "activity" | string)>[];
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/bmi (pkg: hl7.fhir.r5.core#5.0.0)
export class ObservationbmiProfile {
    ...
    static from (resource: Observation) : ObservationbmiProfile {
        return new ObservationbmiProfile(resource)
    }

    static createResource (args: ObservationbmiProfileParams) : Observation {
    ...
    static create (args: ObservationbmiProfileParams) : ObservationbmiProfile {
        return ObservationbmiProfile.from(ObservationbmiProfile.createResource(args))
    }
    ...
    toProfile () : Observationbmi {
        return this.resource as Observationbmi
    }

    public setVSCat (input?: Observationbmi_Category_VSCatSliceInput): this {
    ...
    public getVSCat (): Observationbmi_Category_VSCatSliceInput | undefined {
        const match = {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}} as Record<string, unknown>
        const list = this.resource.category
        if (!list) return undefined
        const item = list.find((item) => matchesSlice(item, match))
        if (!item) return undefined
        return extractSliceSimplified(item as unknown as Record<string, unknown>, ["coding"]) as Observationbmi_Category_VSCatSliceInput
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "Observationbmi"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "Observationbmi"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "Observationbmi"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "Observationbmi.category"))
        { const e = validateRequired(r, "code", "Observationbmi"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"code":"39156-5","system":"http://loinc.org"}]}, "Observationbmi"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "Observationbmi"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["Patient"], "subject", "Observationbmi"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","Observationvitalsigns"], "hasMember", "Observationbmi"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","MolecularSequence","QuestionnaireResponse","Observationvitalsigns"], "derivedFrom", "Observationbmi"); if (e) errors.push(e) }
        return errors
    }
