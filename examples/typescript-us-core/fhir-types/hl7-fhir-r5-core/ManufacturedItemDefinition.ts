...
export const isManufacturedItemDefinition = (resource: unknown): resource is ManufacturedItemDefinition => {
    return resource !== null && typeof resource === "object" && (resource as {resourceType: string}).resourceType === "ManufacturedItemDefinition";
}
