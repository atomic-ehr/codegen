...
export type USCoreBodyTemperatureProfile_Category_VSCatSliceInput = Omit<CodeableConcept, "coding">;
...
export type USCoreBodyTemperatureProfileProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"USCorePatientProfile">;
    category?: CodeableConcept<("social-history" | "vital-signs" | "imaging" | "laboratory" | "procedure" | "survey" | "exam" | "therapy" | "activity" | string)>[];
}

// CanonicalURL: http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-temperature (pkg: hl7.fhir.us.core#8.0.1)
export class USCoreBodyTemperatureProfileProfile {
    static readonly canonicalUrl = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-temperature"
    ...
    constructor (resource: Observation) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-temperature")) profiles.push("http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-temperature")
    }

    static from (resource: Observation) : USCoreBodyTemperatureProfileProfile {
        return new USCoreBodyTemperatureProfileProfile(resource)
    }

    static createResource (args: USCoreBodyTemperatureProfileProfileParams) : Observation {
    ...
    static create (args: USCoreBodyTemperatureProfileProfileParams) : USCoreBodyTemperatureProfileProfile {
        return USCoreBodyTemperatureProfileProfile.from(USCoreBodyTemperatureProfileProfile.createResource(args))
    }
    ...
    toProfile () : USCoreBodyTemperatureProfile {
        return this.resource as USCoreBodyTemperatureProfile
    }

    public setVSCat (input?: USCoreBodyTemperatureProfile_Category_VSCatSliceInput): this {
    ...
    public getVSCat (): USCoreBodyTemperatureProfile_Category_VSCatSliceInput | undefined {
        const match = {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}} as Record<string, unknown>
        const list = this.resource.category
        if (!list) return undefined
        const item = list.find((item) => matchesSlice(item, match))
        if (!item) return undefined
        return extractSliceSimplified(item as unknown as Record<string, unknown>, ["coding"]) as USCoreBodyTemperatureProfile_Category_VSCatSliceInput
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "USCoreBodyTemperatureProfile"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "USCoreBodyTemperatureProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "USCoreBodyTemperatureProfile"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "USCoreBodyTemperatureProfile.category"))
        { const e = validateRequired(r, "code", "USCoreBodyTemperatureProfile"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"system":"http://loinc.org","code":"8310-5"}]}, "USCoreBodyTemperatureProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "USCoreBodyTemperatureProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["USCorePatientProfile"], "subject", "USCoreBodyTemperatureProfile"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "hasMember", "USCoreBodyTemperatureProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","Media","MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "derivedFrom", "USCoreBodyTemperatureProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["performer"], ["PractitionerRole","USCoreCareTeam","USCoreOrganizationProfile","USCorePatientProfile","USCorePractitionerProfile","USCoreRelatedPersonProfile"], "performer", "USCoreBodyTemperatureProfile"); if (e) errors.push(e) }
        return errors
    }
