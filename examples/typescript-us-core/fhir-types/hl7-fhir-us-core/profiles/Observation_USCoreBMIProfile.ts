...
export type USCoreBMIProfile_Category_VSCatSliceInput = Omit<CodeableConcept, "coding">;
...
export type USCoreBMIProfileProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"USCorePatientProfile">;
    category?: CodeableConcept<("social-history" | "vital-signs" | "imaging" | "laboratory" | "procedure" | "survey" | "exam" | "therapy" | "activity" | string)>[];
}

// CanonicalURL: http://hl7.org/fhir/us/core/StructureDefinition/us-core-bmi (pkg: hl7.fhir.us.core#8.0.1)
export class USCoreBMIProfileProfile {
    static readonly canonicalUrl = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-bmi"
    ...
    constructor (resource: Observation) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/us/core/StructureDefinition/us-core-bmi")) profiles.push("http://hl7.org/fhir/us/core/StructureDefinition/us-core-bmi")
    }

    static from (resource: Observation) : USCoreBMIProfileProfile {
        return new USCoreBMIProfileProfile(resource)
    }

    static createResource (args: USCoreBMIProfileProfileParams) : Observation {
    ...
    static create (args: USCoreBMIProfileProfileParams) : USCoreBMIProfileProfile {
        return USCoreBMIProfileProfile.from(USCoreBMIProfileProfile.createResource(args))
    }
    ...
    toProfile () : USCoreBMIProfile {
        return this.resource as USCoreBMIProfile
    }

    public setVSCat (input?: USCoreBMIProfile_Category_VSCatSliceInput): this {
    ...
    public getVSCat (): USCoreBMIProfile_Category_VSCatSliceInput | undefined {
        const match = {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}} as Record<string, unknown>
        const list = this.resource.category
        if (!list) return undefined
        const item = list.find((item) => matchesSlice(item, match))
        if (!item) return undefined
        return extractSliceSimplified(item as unknown as Record<string, unknown>, ["coding"]) as USCoreBMIProfile_Category_VSCatSliceInput
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "USCoreBMIProfile"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "USCoreBMIProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "USCoreBMIProfile"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "USCoreBMIProfile.category"))
        { const e = validateRequired(r, "code", "USCoreBMIProfile"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"system":"http://loinc.org","code":"39156-5"}]}, "USCoreBMIProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "USCoreBMIProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["USCorePatientProfile"], "subject", "USCoreBMIProfile"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "hasMember", "USCoreBMIProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","Media","MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "derivedFrom", "USCoreBMIProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["performer"], ["PractitionerRole","USCoreCareTeam","USCoreOrganizationProfile","USCorePatientProfile","USCorePractitionerProfile","USCoreRelatedPersonProfile"], "performer", "USCoreBMIProfile"); if (e) errors.push(e) }
        return errors
    }
