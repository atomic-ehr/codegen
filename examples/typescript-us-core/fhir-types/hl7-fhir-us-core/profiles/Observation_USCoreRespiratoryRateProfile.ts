...
export type USCoreRespiratoryRateProfileProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"USCorePatientProfile">;
    category?: CodeableConcept<("social-history" | "vital-signs" | "imaging" | "laboratory" | "procedure" | "survey" | "exam" | "therapy" | "activity" | string)>[];
}

// CanonicalURL: http://hl7.org/fhir/us/core/StructureDefinition/us-core-respiratory-rate (pkg: hl7.fhir.us.core#8.0.1)
export class USCoreRespiratoryRateProfileProfile {
    static readonly canonicalUrl = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-respiratory-rate"
    ...
    constructor (resource: Observation) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/us/core/StructureDefinition/us-core-respiratory-rate")) profiles.push("http://hl7.org/fhir/us/core/StructureDefinition/us-core-respiratory-rate")
    }

    static from (resource: Observation) : USCoreRespiratoryRateProfileProfile {
        return new USCoreRespiratoryRateProfileProfile(resource)
    }

    static createResource (args: USCoreRespiratoryRateProfileProfileParams) : Observation {
    ...
    static create (args: USCoreRespiratoryRateProfileProfileParams) : USCoreRespiratoryRateProfileProfile {
        return USCoreRespiratoryRateProfileProfile.from(USCoreRespiratoryRateProfileProfile.createResource(args))
    }
    ...
    public getVSCat (): USCoreRespiratoryRateProfile_Category_VSCatSliceInput | undefined {
        const match = {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}} as Record<string, unknown>
        const list = this.resource.category
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "USCoreRespiratoryRateProfile"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "USCoreRespiratoryRateProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "USCoreRespiratoryRateProfile"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "USCoreRespiratoryRateProfile.category"))
        { const e = validateRequired(r, "code", "USCoreRespiratoryRateProfile"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"system":"http://loinc.org","code":"9279-1"}]}, "USCoreRespiratoryRateProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "USCoreRespiratoryRateProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["USCorePatientProfile"], "subject", "USCoreRespiratoryRateProfile"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "hasMember", "USCoreRespiratoryRateProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","Media","MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "derivedFrom", "USCoreRespiratoryRateProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["performer"], ["PractitionerRole","USCoreCareTeam","USCoreOrganizationProfile","USCorePatientProfile","USCorePractitionerProfile","USCoreRelatedPersonProfile"], "performer", "USCoreRespiratoryRateProfile"); if (e) errors.push(e) }
        return errors
    }
