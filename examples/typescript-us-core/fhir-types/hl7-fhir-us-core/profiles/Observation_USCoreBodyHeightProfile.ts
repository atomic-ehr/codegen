...
export type USCoreBodyHeightProfile_Category_VSCatSliceInput = Omit<CodeableConcept, "coding">;
...
export type USCoreBodyHeightProfileProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"USCorePatientProfile">;
    category?: CodeableConcept<("social-history" | "vital-signs" | "imaging" | "laboratory" | "procedure" | "survey" | "exam" | "therapy" | "activity" | string)>[];
}

// CanonicalURL: http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-height (pkg: hl7.fhir.us.core#8.0.1)
export class USCoreBodyHeightProfileProfile {
    static readonly canonicalUrl = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-height"
    ...
    constructor (resource: Observation) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-height")) profiles.push("http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-height")
    }

    static from (resource: Observation) : USCoreBodyHeightProfileProfile {
        return new USCoreBodyHeightProfileProfile(resource)
    }

    static createResource (args: USCoreBodyHeightProfileProfileParams) : Observation {
    ...
    static create (args: USCoreBodyHeightProfileProfileParams) : USCoreBodyHeightProfileProfile {
        return USCoreBodyHeightProfileProfile.from(USCoreBodyHeightProfileProfile.createResource(args))
    }
    ...
    toProfile () : USCoreBodyHeightProfile {
        return this.resource as USCoreBodyHeightProfile
    }

    public setVSCat (input?: USCoreBodyHeightProfile_Category_VSCatSliceInput): this {
    ...
    public getVSCat (): USCoreBodyHeightProfile_Category_VSCatSliceInput | undefined {
        const match = {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}} as Record<string, unknown>
        const list = this.resource.category
        if (!list) return undefined
        const item = list.find((item) => matchesSlice(item, match))
        if (!item) return undefined
        return extractSliceSimplified(item as unknown as Record<string, unknown>, ["coding"]) as USCoreBodyHeightProfile_Category_VSCatSliceInput
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "USCoreBodyHeightProfile"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "USCoreBodyHeightProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "USCoreBodyHeightProfile"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "USCoreBodyHeightProfile.category"))
        { const e = validateRequired(r, "code", "USCoreBodyHeightProfile"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"system":"http://loinc.org","code":"8302-2"}]}, "USCoreBodyHeightProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "USCoreBodyHeightProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["USCorePatientProfile"], "subject", "USCoreBodyHeightProfile"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "hasMember", "USCoreBodyHeightProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","Media","MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "derivedFrom", "USCoreBodyHeightProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["performer"], ["PractitionerRole","USCoreCareTeam","USCoreOrganizationProfile","USCorePatientProfile","USCorePractitionerProfile","USCoreRelatedPersonProfile"], "performer", "USCoreBodyHeightProfile"); if (e) errors.push(e) }
        return errors
    }
