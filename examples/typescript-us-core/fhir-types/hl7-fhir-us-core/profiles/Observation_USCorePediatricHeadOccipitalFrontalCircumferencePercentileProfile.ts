...
export type USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile_Category_VSCatSliceInput = Omit<CodeableConcept, "coding">;
...
export type USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"USCorePatientProfile">;
    category?: CodeableConcept<("social-history" | "vital-signs" | "imaging" | "laboratory" | "procedure" | "survey" | "exam" | "therapy" | "activity" | string)>[];
}

// CanonicalURL: http://hl7.org/fhir/us/core/StructureDefinition/head-occipital-frontal-circumference-percentile (pkg: hl7.fhir.us.core#8.0.1)
export class USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileProfile {
    static readonly canonicalUrl = "http://hl7.org/fhir/us/core/StructureDefinition/head-occipital-frontal-circumference-percentile"
    ...
    constructor (resource: Observation) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/us/core/StructureDefinition/head-occipital-frontal-circumference-percentile")) profiles.push("http://hl7.org/fhir/us/core/StructureDefinition/head-occipital-frontal-circumference-percentile")
    }

    static from (resource: Observation) : USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileProfile {
        return new USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileProfile(resource)
    }

    static createResource (args: USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileProfileParams) : Observation {
        ...
        const resource: Observation = {
            ...
            code: {"coding":[{"system":"http://loinc.org","code":"8289-1"}]},
            category: categoryWithDefaults,
            status: args.status,
            subject: args.subject,
            meta: { profile: ["http://hl7.org/fhir/us/core/StructureDefinition/head-occipital-frontal-circumference-percentile"] },
        } as unknown as Observation
        return resource
    }

    static create (args: USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileProfileParams) : USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileProfile {
        return USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileProfile.from(USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileProfile.createResource(args))
    }
    ...
    toProfile () : USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile {
        return this.resource as USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile
    }

    public setVSCat (input?: USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile_Category_VSCatSliceInput): this {
    ...
    public getVSCat (): USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile_Category_VSCatSliceInput | undefined {
        const match = {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}} as Record<string, unknown>
        const list = this.resource.category
        if (!list) return undefined
        const item = list.find((item) => matchesSlice(item, match))
        if (!item) return undefined
        return extractSliceSimplified(item as unknown as Record<string, unknown>, ["coding"]) as USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile_Category_VSCatSliceInput
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile.category"))
        { const e = validateRequired(r, "code", "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"system":"http://loinc.org","code":"8289-1"}]}, "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["USCorePatientProfile"], "subject", "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "hasMember", "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","Media","MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "derivedFrom", "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["performer"], ["PractitionerRole","USCoreCareTeam","USCoreOrganizationProfile","USCorePatientProfile","USCorePractitionerProfile","USCoreRelatedPersonProfile"], "performer", "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile"); if (e) errors.push(e) }
        return errors
    }
