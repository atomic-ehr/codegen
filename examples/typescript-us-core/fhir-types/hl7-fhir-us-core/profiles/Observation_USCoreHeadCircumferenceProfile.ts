...
export type USCoreHeadCircumferenceProfile_Category_VSCatSliceInput = Omit<CodeableConcept, "coding">;
...
export type USCoreHeadCircumferenceProfileProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"USCorePatientProfile">;
    category?: CodeableConcept<("social-history" | "vital-signs" | "imaging" | "laboratory" | "procedure" | "survey" | "exam" | "therapy" | "activity" | string)>[];
}

// CanonicalURL: http://hl7.org/fhir/us/core/StructureDefinition/us-core-head-circumference (pkg: hl7.fhir.us.core#8.0.1)
export class USCoreHeadCircumferenceProfileProfile {
    ...
    constructor (resource: Observation) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/us/core/StructureDefinition/us-core-head-circumference")) profiles.push("http://hl7.org/fhir/us/core/StructureDefinition/us-core-head-circumference")
    }

    static from (resource: Observation) : USCoreHeadCircumferenceProfileProfile {
        return new USCoreHeadCircumferenceProfileProfile(resource)
    }

    static createResource (args: USCoreHeadCircumferenceProfileProfileParams) : Observation {
        ...
        const resource: Observation = {
            ...
            code: {"coding":[{"system":"http://loinc.org","code":"9843-4"}]},
    ...
    static create (args: USCoreHeadCircumferenceProfileProfileParams) : USCoreHeadCircumferenceProfileProfile {
        return USCoreHeadCircumferenceProfileProfile.from(USCoreHeadCircumferenceProfileProfile.createResource(args))
    }
    ...
    toProfile () : USCoreHeadCircumferenceProfile {
        return this.resource as USCoreHeadCircumferenceProfile
    }

    public setVSCat (input?: USCoreHeadCircumferenceProfile_Category_VSCatSliceInput): this {
    ...
    public getVSCat (): USCoreHeadCircumferenceProfile_Category_VSCatSliceInput | undefined {
        const match = {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}} as Record<string, unknown>
        const list = this.resource.category
        if (!list) return undefined
        const item = list.find((item) => matchesSlice(item, match))
        if (!item) return undefined
        return extractSliceSimplified(item as unknown as Record<string, unknown>, ["coding"]) as USCoreHeadCircumferenceProfile_Category_VSCatSliceInput
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "USCoreHeadCircumferenceProfile"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "USCoreHeadCircumferenceProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "USCoreHeadCircumferenceProfile"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "USCoreHeadCircumferenceProfile.category"))
        { const e = validateRequired(r, "code", "USCoreHeadCircumferenceProfile"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"system":"http://loinc.org","code":"9843-4"}]}, "USCoreHeadCircumferenceProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "USCoreHeadCircumferenceProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["USCorePatientProfile"], "subject", "USCoreHeadCircumferenceProfile"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "hasMember", "USCoreHeadCircumferenceProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","Media","MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "derivedFrom", "USCoreHeadCircumferenceProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["performer"], ["PractitionerRole","USCoreCareTeam","USCoreOrganizationProfile","USCorePatientProfile","USCorePractitionerProfile","USCoreRelatedPersonProfile"], "performer", "USCoreHeadCircumferenceProfile"); if (e) errors.push(e) }
        return errors
    }
