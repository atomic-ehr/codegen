...
export type USCorePulseOximetryProfileProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"USCorePatientProfile">;
    category?: CodeableConcept<("social-history" | "vital-signs" | "imaging" | "laboratory" | "procedure" | "survey" | "exam" | "therapy" | "activity" | string)>[];
}

// CanonicalURL: http://hl7.org/fhir/us/core/StructureDefinition/us-core-pulse-oximetry (pkg: hl7.fhir.us.core#8.0.1)
export class USCorePulseOximetryProfileProfile {
    static readonly canonicalUrl = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-pulse-oximetry"
    ...
    constructor (resource: Observation) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/us/core/StructureDefinition/us-core-pulse-oximetry")) profiles.push("http://hl7.org/fhir/us/core/StructureDefinition/us-core-pulse-oximetry")
    }

    static from (resource: Observation) : USCorePulseOximetryProfileProfile {
        return new USCorePulseOximetryProfileProfile(resource)
    }

    static createResource (args: USCorePulseOximetryProfileProfileParams) : Observation {
        ...
        const resource: Observation = {
            ...
            code: {"coding":[{"system":"http://loinc.org","code":"59408-5"},{"system":"http://loinc.org","code":"2708-6"}]},
    ...
    static create (args: USCorePulseOximetryProfileProfileParams) : USCorePulseOximetryProfileProfile {
        return USCorePulseOximetryProfileProfile.from(USCorePulseOximetryProfileProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "USCorePulseOximetryProfile"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "USCorePulseOximetryProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "USCorePulseOximetryProfile"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "USCorePulseOximetryProfile.category"))
        { const e = validateRequired(r, "code", "USCorePulseOximetryProfile"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"system":"http://loinc.org","code":"59408-5"},{"system":"http://loinc.org","code":"2708-6"}]}, "USCorePulseOximetryProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "USCorePulseOximetryProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["USCorePatientProfile"], "subject", "USCorePulseOximetryProfile"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "hasMember", "USCorePulseOximetryProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","Media","MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "derivedFrom", "USCorePulseOximetryProfile"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["component"] as unknown[] | undefined, {"code":{"coding":[{"system":"http://loinc.org","code":"3151-8"}]}}, "FlowRate", 0, 1, "USCorePulseOximetryProfile.component"))
        errors.push(...validateSliceCardinality(r["component"] as unknown[] | undefined, {"code":{"coding":[{"system":"http://loinc.org","code":"3150-0"}]}}, "Concentration", 0, 1, "USCorePulseOximetryProfile.component"))
        { const e = validateReference(r["performer"], ["PractitionerRole","USCoreCareTeam","USCoreOrganizationProfile","USCorePatientProfile","USCorePractitionerProfile","USCoreRelatedPersonProfile"], "performer", "USCorePulseOximetryProfile"); if (e) errors.push(e) }
        return errors
    }
