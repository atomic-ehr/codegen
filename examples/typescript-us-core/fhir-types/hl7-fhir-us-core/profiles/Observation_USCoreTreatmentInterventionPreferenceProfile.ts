...
export type USCoreTreatmentInterventionPreferenceProfileProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"USCorePatientProfile">;
}

// CanonicalURL: http://hl7.org/fhir/us/core/StructureDefinition/us-core-treatment-intervention-preference (pkg: hl7.fhir.us.core#8.0.1)
export class USCoreTreatmentInterventionPreferenceProfileProfile {
    static readonly canonicalUrl = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-treatment-intervention-preference"
    ...
    constructor (resource: Observation) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/us/core/StructureDefinition/us-core-treatment-intervention-preference")) profiles.push("http://hl7.org/fhir/us/core/StructureDefinition/us-core-treatment-intervention-preference")
    }

    static from (resource: Observation) : USCoreTreatmentInterventionPreferenceProfileProfile {
        return new USCoreTreatmentInterventionPreferenceProfileProfile(resource)
    }

    static createResource (args: USCoreTreatmentInterventionPreferenceProfileProfileParams) : Observation {
        const resource: Observation = {
            resourceType: "Observation",
            code: {"coding":[{"system":"http://loinc.org","code":"75773-2"}]},
            status: args.status,
    ...
    static create (args: USCoreTreatmentInterventionPreferenceProfileProfileParams) : USCoreTreatmentInterventionPreferenceProfileProfile {
        return USCoreTreatmentInterventionPreferenceProfileProfile.from(USCoreTreatmentInterventionPreferenceProfileProfile.createResource(args))
    }
    ...
    public setUs_core (input?: USCoreTreatmentInterventionPreferenceProfile_Category_Us_coreSliceInput): this {
    ...
    public getUs_core (): USCoreTreatmentInterventionPreferenceProfile_Category_Us_coreSliceInput | undefined {
        const match = {"coding":[{"system":"http://hl7.org/fhir/us/core/CodeSystem/us-core-category","code":"treatment-intervention-preference"}]} as Record<string, unknown>
        const list = this.resource.category
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "USCoreTreatmentInterventionPreferenceProfile"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "USCoreTreatmentInterventionPreferenceProfile"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":[{"system":"http://hl7.org/fhir/us/core/CodeSystem/us-core-category","code":"treatment-intervention-preference"}]}, "us-core", 0, 1, "USCoreTreatmentInterventionPreferenceProfile.category"))
        { const e = validateRequired(r, "code", "USCoreTreatmentInterventionPreferenceProfile"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"system":"http://loinc.org","code":"75773-2"}]}, "USCoreTreatmentInterventionPreferenceProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "USCoreTreatmentInterventionPreferenceProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["USCorePatientProfile"], "subject", "USCoreTreatmentInterventionPreferenceProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["performer"], ["PractitionerRole","USCoreCareTeam","USCoreOrganizationProfile","USCorePatientProfile","USCorePractitionerProfile","USCoreRelatedPersonProfile"], "performer", "USCoreTreatmentInterventionPreferenceProfile"); if (e) errors.push(e) }
        return errors
    }
