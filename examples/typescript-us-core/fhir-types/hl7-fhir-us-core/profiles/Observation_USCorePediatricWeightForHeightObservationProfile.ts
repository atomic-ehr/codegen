...
export type USCorePediatricWeightForHeightObservationProfile_Category_VSCatSliceInput = Omit<CodeableConcept, "coding">;
...
export type USCorePediatricWeightForHeightObservationProfileProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"USCorePatientProfile">;
}

// CanonicalURL: http://hl7.org/fhir/us/core/StructureDefinition/pediatric-weight-for-height (pkg: hl7.fhir.us.core#8.0.1)
export class USCorePediatricWeightForHeightObservationProfileProfile {
    static readonly canonicalUrl = "http://hl7.org/fhir/us/core/StructureDefinition/pediatric-weight-for-height"
    ...
    constructor (resource: Observation) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/us/core/StructureDefinition/pediatric-weight-for-height")) profiles.push("http://hl7.org/fhir/us/core/StructureDefinition/pediatric-weight-for-height")
    }

    static from (resource: Observation) : USCorePediatricWeightForHeightObservationProfileProfile {
        return new USCorePediatricWeightForHeightObservationProfileProfile(resource)
    }

    static createResource (args: USCorePediatricWeightForHeightObservationProfileProfileParams) : Observation {
        const resource: Observation = {
            resourceType: "Observation",
            category: [{"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}],
            code: {"coding":[{"system":"http://loinc.org","code":"77606-2"}]},
            status: args.status,
            subject: args.subject,
            meta: { profile: ["http://hl7.org/fhir/us/core/StructureDefinition/pediatric-weight-for-height"] },
        } as unknown as Observation
        return resource
    }

    static create (args: USCorePediatricWeightForHeightObservationProfileProfileParams) : USCorePediatricWeightForHeightObservationProfileProfile {
        return USCorePediatricWeightForHeightObservationProfileProfile.from(USCorePediatricWeightForHeightObservationProfileProfile.createResource(args))
    }
    ...
    toProfile () : USCorePediatricWeightForHeightObservationProfile {
        return this.resource as USCorePediatricWeightForHeightObservationProfile
    }

    public setVscat (input?: USCorePediatricWeightForHeightObservationProfile_Category_VSCatSliceInput): this {
    ...
    public getVscat (): USCorePediatricWeightForHeightObservationProfile_Category_VSCatSliceInput | undefined {
        const match = {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}} as Record<string, unknown>
        const list = this.resource.category
        if (!list) return undefined
        const item = list.find((item) => matchesSlice(item, match))
        if (!item) return undefined
        return extractSliceSimplified(item as unknown as Record<string, unknown>, ["coding"]) as USCorePediatricWeightForHeightObservationProfile_Category_VSCatSliceInput
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "USCorePediatricWeightForHeightObservationProfile"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "USCorePediatricWeightForHeightObservationProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "USCorePediatricWeightForHeightObservationProfile"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "USCorePediatricWeightForHeightObservationProfile.category"))
        { const e = validateRequired(r, "code", "USCorePediatricWeightForHeightObservationProfile"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"system":"http://loinc.org","code":"77606-2"}]}, "USCorePediatricWeightForHeightObservationProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "USCorePediatricWeightForHeightObservationProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["USCorePatientProfile"], "subject", "USCorePediatricWeightForHeightObservationProfile"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "hasMember", "USCorePediatricWeightForHeightObservationProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","Media","MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "derivedFrom", "USCorePediatricWeightForHeightObservationProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["performer"], ["PractitionerRole","USCoreCareTeam","USCoreOrganizationProfile","USCorePatientProfile","USCorePractitionerProfile","USCoreRelatedPersonProfile"], "performer", "USCorePediatricWeightForHeightObservationProfile"); if (e) errors.push(e) }
        return errors
    }
