...
export class USCoreBodyWeightProfileProfile {
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "USCoreBodyWeightProfile"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "USCoreBodyWeightProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "USCoreBodyWeightProfile"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "USCoreBodyWeightProfile.category"))
        { const e = validateRequired(r, "code", "USCoreBodyWeightProfile"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"system":"http://loinc.org","code":"29463-7"}]}, "USCoreBodyWeightProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "USCoreBodyWeightProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["USCorePatientProfile"], "subject", "USCoreBodyWeightProfile"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "hasMember", "USCoreBodyWeightProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","Media","MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "derivedFrom", "USCoreBodyWeightProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["performer"], ["PractitionerRole","USCoreCareTeam","USCoreOrganizationProfile","USCorePatientProfile","USCorePractitionerProfile","USCoreRelatedPersonProfile"], "performer", "USCoreBodyWeightProfile"); if (e) errors.push(e) }
        return errors
    }
