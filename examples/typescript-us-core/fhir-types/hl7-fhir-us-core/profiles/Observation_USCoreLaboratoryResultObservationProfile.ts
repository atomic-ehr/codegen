...
export type USCoreLaboratoryResultObservationProfileProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    code: CodeableConcept;
    subject: Reference<"Device" | "Group" | "USCoreLocationProfile" | "USCorePatientProfile">;
}

// CanonicalURL: http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-lab (pkg: hl7.fhir.us.core#8.0.1)
export class USCoreLaboratoryResultObservationProfileProfile {
    static readonly canonicalUrl = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-lab"
    ...
    constructor (resource: Observation) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-lab")) profiles.push("http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-lab")
    }

    static from (resource: Observation) : USCoreLaboratoryResultObservationProfileProfile {
        return new USCoreLaboratoryResultObservationProfileProfile(resource)
    }

    static createResource (args: USCoreLaboratoryResultObservationProfileProfileParams) : Observation {
    ...
    static create (args: USCoreLaboratoryResultObservationProfileProfileParams) : USCoreLaboratoryResultObservationProfileProfile {
        return USCoreLaboratoryResultObservationProfileProfile.from(USCoreLaboratoryResultObservationProfileProfile.createResource(args))
    }
    ...
    toProfile () : USCoreLaboratoryResultObservationProfile {
        return this.resource as USCoreLaboratoryResultObservationProfile
    }

    validate () : string[] {
        const errors: string[] = []
        const r = this.resource as unknown as Record<string, unknown>
        { const e = validateRequired(r, "status", "USCoreLaboratoryResultObservationProfile"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "USCoreLaboratoryResultObservationProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "USCoreLaboratoryResultObservationProfile"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "category", {"coding":[{"system":"http://terminology.hl7.org/CodeSystem/observation-category","code":"laboratory"}]}, "USCoreLaboratoryResultObservationProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "code", "USCoreLaboratoryResultObservationProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "USCoreLaboratoryResultObservationProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["Device","Group","USCoreLocationProfile","USCorePatientProfile"], "subject", "USCoreLaboratoryResultObservationProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["encounter"], ["USCoreEncounterProfile"], "encounter", "USCoreLaboratoryResultObservationProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["performer"], ["PractitionerRole","USCoreCareTeam","USCoreOrganizationProfile","USCorePatientProfile","USCorePractitionerProfile","USCoreRelatedPersonProfile"], "performer", "USCoreLaboratoryResultObservationProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["specimen"], ["USCoreSpecimenProfile"], "specimen", "USCoreLaboratoryResultObservationProfile"); if (e) errors.push(e) }
        return errors
    }
