...
export type USCoreHeartRateProfile_Category_VSCatSliceInput = Omit<CodeableConcept, "coding">;
...
export type USCoreHeartRateProfileProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"USCorePatientProfile">;
}

// CanonicalURL: http://hl7.org/fhir/us/core/StructureDefinition/us-core-heart-rate (pkg: hl7.fhir.us.core#8.0.1)
export class USCoreHeartRateProfileProfile {
    static readonly canonicalUrl = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-heart-rate"
    ...
    constructor (resource: Observation) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/us/core/StructureDefinition/us-core-heart-rate")) profiles.push("http://hl7.org/fhir/us/core/StructureDefinition/us-core-heart-rate")
    }

    static from (resource: Observation) : USCoreHeartRateProfileProfile {
        return new USCoreHeartRateProfileProfile(resource)
    }

    static createResource (args: USCoreHeartRateProfileProfileParams) : Observation {
    ...
    static create (args: USCoreHeartRateProfileProfileParams) : USCoreHeartRateProfileProfile {
        return USCoreHeartRateProfileProfile.from(USCoreHeartRateProfileProfile.createResource(args))
    }
    ...
    toProfile () : USCoreHeartRateProfile {
        return this.resource as USCoreHeartRateProfile
    }

    public setVscat (input?: USCoreHeartRateProfile_Category_VSCatSliceInput): this {
    ...
    public getVscat (): USCoreHeartRateProfile_Category_VSCatSliceInput | undefined {
        const match = {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}} as Record<string, unknown>
        const list = this.resource.category
        if (!list) return undefined
        const item = list.find((item) => matchesSlice(item, match))
        if (!item) return undefined
        return extractSliceSimplified(item as unknown as Record<string, unknown>, ["coding"]) as USCoreHeartRateProfile_Category_VSCatSliceInput
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "USCoreHeartRateProfile"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "USCoreHeartRateProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "USCoreHeartRateProfile"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "USCoreHeartRateProfile.category"))
        { const e = validateRequired(r, "code", "USCoreHeartRateProfile"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"system":"http://loinc.org","code":"8867-4"}]}, "USCoreHeartRateProfile"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "USCoreHeartRateProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["USCorePatientProfile"], "subject", "USCoreHeartRateProfile"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "hasMember", "USCoreHeartRateProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","Media","MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "derivedFrom", "USCoreHeartRateProfile"); if (e) errors.push(e) }
        { const e = validateReference(r["performer"], ["PractitionerRole","USCoreCareTeam","USCoreOrganizationProfile","USCorePatientProfile","USCorePractitionerProfile","USCoreRelatedPersonProfile"], "performer", "USCoreHeartRateProfile"); if (e) errors.push(e) }
        return errors
    }
