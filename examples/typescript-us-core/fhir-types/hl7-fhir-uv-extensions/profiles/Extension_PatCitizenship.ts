...
// CanonicalURL: http://hl7.org/fhir/StructureDefinition/patient-citizenship (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class PatCitizenshipProfile {
    ...
    static from (resource: Extension) : PatCitizenshipProfile {
        return new PatCitizenshipProfile(resource)
    }
    ...
    static create () : PatCitizenshipProfile {
        return PatCitizenshipProfile.from(PatCitizenshipProfile.createResource())
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "PatCitizenship"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/patient-citizenship", "PatCitizenship"); if (e) errors.push(e) }
        return errors
    }
