...
// CanonicalURL: http://hl7.org/fhir/StructureDefinition/cqf-expansionParameters (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class ExpansionParametersProfile {
    ...
    static create () : ExpansionParametersProfile {
        return ExpansionParametersProfile.from(ExpansionParametersProfile.createResource())
    }
