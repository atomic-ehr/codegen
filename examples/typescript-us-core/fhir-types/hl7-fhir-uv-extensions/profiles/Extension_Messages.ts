...
// CanonicalURL: http://hl7.org/fhir/StructureDefinition/cqf-messages (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class MessagesProfile {
    ...
    static create () : MessagesProfile {
        return MessagesProfile.from(MessagesProfile.createResource())
    }
