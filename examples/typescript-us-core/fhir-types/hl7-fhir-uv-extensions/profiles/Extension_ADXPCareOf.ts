...
export type ADXPCareOfProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-careOf (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class ADXPCareOfProfile {
    ...
    static from (resource: Extension) : ADXPCareOfProfile {
        return new ADXPCareOfProfile(resource)
    }

    static createResource (args: ADXPCareOfProfileParams) : Extension {
    ...
    static create (args: ADXPCareOfProfileParams) : ADXPCareOfProfile {
        return ADXPCareOfProfile.from(ADXPCareOfProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "ADXPCareOf"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-careOf", "ADXPCareOf"); if (e) errors.push(e) }
