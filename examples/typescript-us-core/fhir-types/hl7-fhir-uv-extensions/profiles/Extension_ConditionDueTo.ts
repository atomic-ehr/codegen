...
// CanonicalURL: http://hl7.org/fhir/StructureDefinition/condition-dueTo (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class ConditionDueToProfile {
    ...
    static from (resource: Extension) : ConditionDueToProfile {
        return new ConditionDueToProfile(resource)
    }
    ...
    static create () : ConditionDueToProfile {
        return ConditionDueToProfile.from(ConditionDueToProfile.createResource())
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "ConditionDueTo"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/condition-dueTo", "ConditionDueTo"); if (e) errors.push(e) }
