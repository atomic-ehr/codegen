...
// CanonicalURL: http://hl7.org/fhir/StructureDefinition/condition-occurredFollowing (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class ConditionOccurredFollowingProfile {
    ...
    static from (resource: Extension) : ConditionOccurredFollowingProfile {
        return new ConditionOccurredFollowingProfile(resource)
    }
    ...
    static create () : ConditionOccurredFollowingProfile {
        return ConditionOccurredFollowingProfile.from(ConditionOccurredFollowingProfile.createResource())
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "ConditionOccurredFollowing"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/condition-occurredFollowing", "ConditionOccurredFollowing"); if (e) errors.push(e) }
