...
// CanonicalURL: http://hl7.org/fhir/StructureDefinition/artifact-isOwned (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class ArtifactIsOwnedProfile {
    ...
    static create () : ArtifactIsOwnedProfile {
        return ArtifactIsOwnedProfile.from(ArtifactIsOwnedProfile.createResource())
    }
