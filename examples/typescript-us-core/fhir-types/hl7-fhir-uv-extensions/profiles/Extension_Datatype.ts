...
export type DatatypeProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/_datatype (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class DatatypeProfile {
    static readonly canonicalUrl = "http://hl7.org/fhir/StructureDefinition/_datatype"
    ...
    static from (resource: Extension) : DatatypeProfile {
        return new DatatypeProfile(resource)
    }

    static createResource (args: DatatypeProfileParams) : Extension {
    ...
    static create (args: DatatypeProfileParams) : DatatypeProfile {
        return DatatypeProfile.from(DatatypeProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "Datatype"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/_datatype", "Datatype"); if (e) errors.push(e) }
