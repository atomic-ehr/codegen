...
export type PRMethodProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/procedure-method (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class PRMethodProfile {
    ...
    static from (resource: Extension) : PRMethodProfile {
        return new PRMethodProfile(resource)
    }

    static createResource (args: PRMethodProfileParams) : Extension {
    ...
    static create (args: PRMethodProfileParams) : PRMethodProfile {
        return PRMethodProfile.from(PRMethodProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "PRMethod"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/procedure-method", "PRMethod"); if (e) errors.push(e) }
