...
// CanonicalURL: http://hl7.org/fhir/StructureDefinition/cqf-isPrimaryCitation (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class IsPrimaryCitationProfile {
    ...
    static create () : IsPrimaryCitationProfile {
        return IsPrimaryCitationProfile.from(IsPrimaryCitationProfile.createResource())
    }
