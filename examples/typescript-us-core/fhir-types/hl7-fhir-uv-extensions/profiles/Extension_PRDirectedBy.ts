...
// CanonicalURL: http://hl7.org/fhir/StructureDefinition/procedure-directedBy (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class PRDirectedByProfile {
    ...
    static from (resource: Extension) : PRDirectedByProfile {
        return new PRDirectedByProfile(resource)
    }
    ...
    static create () : PRDirectedByProfile {
        return PRDirectedByProfile.from(PRDirectedByProfile.createResource())
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "PRDirectedBy"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/procedure-directedBy", "PRDirectedBy"); if (e) errors.push(e) }
