...
export type VSLabelProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/valueset-label (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class VSLabelProfile {
    ...
    static from (resource: Extension) : VSLabelProfile {
        return new VSLabelProfile(resource)
    }

    static createResource (args: VSLabelProfileParams) : Extension {
    ...
    static create (args: VSLabelProfileParams) : VSLabelProfile {
        return VSLabelProfile.from(VSLabelProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "VSLabel"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/valueset-label", "VSLabel"); if (e) errors.push(e) }
