...
export type CQFCitationProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/cqf-citation (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class CQFCitationProfile {
    ...
    static from (resource: Extension) : CQFCitationProfile {
        return new CQFCitationProfile(resource)
    }

    static createResource (args: CQFCitationProfileParams) : Extension {
    ...
    static create (args: CQFCitationProfileParams) : CQFCitationProfile {
        return CQFCitationProfile.from(CQFCitationProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "CQFCitation"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/cqf-citation", "CQFCitation"); if (e) errors.push(e) }
