...
// CanonicalURL: http://hl7.org/fhir/StructureDefinition/patient-proficiency (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class PatProficiencyProfile {
    ...
    static from (resource: Extension) : PatProficiencyProfile {
        return new PatProficiencyProfile(resource)
    }
    ...
    static create () : PatProficiencyProfile {
        return PatProficiencyProfile.from(PatProficiencyProfile.createResource())
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "PatProficiency"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/patient-proficiency", "PatProficiency"); if (e) errors.push(e) }
        return errors
    }
