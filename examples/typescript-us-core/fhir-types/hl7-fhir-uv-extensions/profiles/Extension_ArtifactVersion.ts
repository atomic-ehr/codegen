...
export type ArtifactVersionProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/artifact-version (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class ArtifactVersionProfile {
    static readonly canonicalUrl = "http://hl7.org/fhir/StructureDefinition/artifact-version"
    ...
    static from (resource: Extension) : ArtifactVersionProfile {
        return new ArtifactVersionProfile(resource)
    }
    ...
    static create (args: ArtifactVersionProfileParams) : ArtifactVersionProfile {
        return ArtifactVersionProfile.from(ArtifactVersionProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "ArtifactVersion"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/artifact-version", "ArtifactVersion"); if (e) errors.push(e) }
