...
export type VSKeywordProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/valueset-keyWord (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class VSKeywordProfile {
    ...
    static from (resource: Extension) : VSKeywordProfile {
        return new VSKeywordProfile(resource)
    }

    static createResource (args: VSKeywordProfileParams) : Extension {
    ...
    static create (args: VSKeywordProfileParams) : VSKeywordProfile {
        return VSKeywordProfile.from(VSKeywordProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "VSKeyword"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/valueset-keyWord", "VSKeyword"); if (e) errors.push(e) }
