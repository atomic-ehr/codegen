...
export type PatAdoptionInfoProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/patient-adoptionInfo (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class PatAdoptionInfoProfile {
    ...
    static from (resource: Extension) : PatAdoptionInfoProfile {
        return new PatAdoptionInfoProfile(resource)
    }

    static createResource (args: PatAdoptionInfoProfileParams) : Extension {
    ...
    static create (args: PatAdoptionInfoProfileParams) : PatAdoptionInfoProfile {
        return PatAdoptionInfoProfile.from(PatAdoptionInfoProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "PatAdoptionInfo"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/patient-adoptionInfo", "PatAdoptionInfo"); if (e) errors.push(e) }
