...
export type ObsDeltaProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/observation-delta (pkg: hl7.fhir.uv.extensions#5.1.0-snapshot1)
export class ObsDeltaProfile {
    ...
    static from (resource: Extension) : ObsDeltaProfile {
        return new ObsDeltaProfile(resource)
    }

    static createResource (args: ObsDeltaProfileParams) : Extension {
    ...
    static create (args: ObsDeltaProfileParams) : ObsDeltaProfile {
        return ObsDeltaProfile.from(ObsDeltaProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "ObsDelta"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/observation-delta", "ObsDelta"); if (e) errors.push(e) }
