...
// CanonicalURL: http://hl7.org/fhir/StructureDefinition/event-recorded (pkg: hl7.fhir.uv.extensions.r4#5.2.0)
export class EventRecordedProfile {
    static readonly canonicalUrl = "http://hl7.org/fhir/StructureDefinition/event-recorded"
    ...
    static from (resource: Extension) : EventRecordedProfile {
        return new EventRecordedProfile(resource)
    }
    ...
    static create () : EventRecordedProfile {
        return EventRecordedProfile.from(EventRecordedProfile.createResource())
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "EventRecorded"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/event-recorded", "EventRecorded"); if (e) errors.push(e) }
        return errors
    }
