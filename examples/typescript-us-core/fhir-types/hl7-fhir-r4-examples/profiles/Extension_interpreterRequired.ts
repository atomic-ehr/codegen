...
export type interpreterRequiredProfileParams = {
    valueBoolean: boolean;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/patient-interpreterRequired (pkg: hl7.fhir.r4.examples#4.0.1)
export class interpreterRequiredProfile {
    ...
    static createResource (args: interpreterRequiredProfileParams) : Extension {
    ...
    static create (args: interpreterRequiredProfileParams) : interpreterRequiredProfile {
        return interpreterRequiredProfile.from(interpreterRequiredProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "interpreterRequired"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/patient-interpreterRequired", "interpreterRequired"); if (e) errors.push(e) }
