...
export type categoryProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/structuredefinition-category (pkg: hl7.fhir.r4.examples#4.0.1)
export class categoryProfile {
    ...
    static createResource (args: categoryProfileParams) : Extension {
    ...
    static create (args: categoryProfileParams) : categoryProfile {
        return categoryProfile.from(categoryProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "category"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/structuredefinition-category", "category"); if (e) errors.push(e) }
