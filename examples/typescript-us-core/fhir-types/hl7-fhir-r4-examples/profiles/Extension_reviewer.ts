...
export type reviewerProfileParams = {
    valueReference: Reference;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/questionnaireresponse-reviewer (pkg: hl7.fhir.r4.examples#4.0.1)
export class reviewerProfile {
    ...
    static createResource (args: reviewerProfileParams) : Extension {
    ...
    static create (args: reviewerProfileParams) : reviewerProfile {
        return reviewerProfile.from(reviewerProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "reviewer"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/questionnaireresponse-reviewer", "reviewer"); if (e) errors.push(e) }
