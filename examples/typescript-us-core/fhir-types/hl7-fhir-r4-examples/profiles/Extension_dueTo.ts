...
// CanonicalURL: http://hl7.org/fhir/StructureDefinition/condition-dueTo (pkg: hl7.fhir.r4.examples#4.0.1)
export class dueToProfile {
    ...
    static create () : dueToProfile {
        return dueToProfile.from(dueToProfile.createResource())
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "dueTo"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/condition-dueTo", "dueTo"); if (e) errors.push(e) }
