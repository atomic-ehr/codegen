...
export type priorityProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/flag-priority (pkg: hl7.fhir.r4.examples#4.0.1)
export class priorityProfile {
    ...
    static createResource (args: priorityProfileParams) : Extension {
    ...
    static create (args: priorityProfileParams) : priorityProfile {
        return priorityProfile.from(priorityProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "priority"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/flag-priority", "priority"); if (e) errors.push(e) }
