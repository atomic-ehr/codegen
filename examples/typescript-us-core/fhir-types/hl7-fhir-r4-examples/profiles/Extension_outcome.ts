...
export type outcomeProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/condition-outcome (pkg: hl7.fhir.r4.examples#4.0.1)
export class outcomeProfile {
    ...
    static createResource (args: outcomeProfileParams) : Extension {
    ...
    static create (args: outcomeProfileParams) : outcomeProfile {
        return outcomeProfile.from(outcomeProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "outcome"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/condition-outcome", "outcome"); if (e) errors.push(e) }
