...
export type labelProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/valueset-label (pkg: hl7.fhir.r4.examples#4.0.1)
export class labelProfile {
    ...
    static createResource (args: labelProfileParams) : Extension {
    ...
    static create (args: labelProfileParams) : labelProfile {
        return labelProfile.from(labelProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "label"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/valueset-label", "label"); if (e) errors.push(e) }
