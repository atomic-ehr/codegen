...
export type groupProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/usagecontext-group (pkg: hl7.fhir.r4.examples#4.0.1)
export class groupProfile {
    ...
    static createResource (args: groupProfileParams) : Extension {
    ...
    static create (args: groupProfileParams) : groupProfile {
        return groupProfile.from(groupProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "group"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/usagecontext-group", "group"); if (e) errors.push(e) }
