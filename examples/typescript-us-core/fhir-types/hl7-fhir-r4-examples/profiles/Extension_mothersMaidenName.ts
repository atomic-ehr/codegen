...
export type mothersMaidenNameProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/patient-mothersMaidenName (pkg: hl7.fhir.r4.examples#4.0.1)
export class mothersMaidenNameProfile {
    ...
    static createResource (args: mothersMaidenNameProfileParams) : Extension {
    ...
    static create (args: mothersMaidenNameProfileParams) : mothersMaidenNameProfile {
        return mothersMaidenNameProfile.from(mothersMaidenNameProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "mothersMaidenName"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/patient-mothersMaidenName", "mothersMaidenName"); if (e) errors.push(e) }
