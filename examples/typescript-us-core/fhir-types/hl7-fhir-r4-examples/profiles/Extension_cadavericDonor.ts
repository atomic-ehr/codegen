...
export type cadavericDonorProfileParams = {
    valueBoolean: boolean;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/patient-cadavericDonor (pkg: hl7.fhir.r4.examples#4.0.1)
export class cadavericDonorProfile {
    ...
    static createResource (args: cadavericDonorProfileParams) : Extension {
    ...
    static create (args: cadavericDonorProfileParams) : cadavericDonorProfile {
        return cadavericDonorProfile.from(cadavericDonorProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "cadavericDonor"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/patient-cadavericDonor", "cadavericDonor"); if (e) errors.push(e) }
