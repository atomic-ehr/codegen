...
export type countryProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/contactpoint-country (pkg: hl7.fhir.r4.examples#4.0.1)
export class countryProfile {
    ...
    static createResource (args: countryProfileParams) : Extension {
    ...
    static create (args: countryProfileParams) : countryProfile {
        return countryProfile.from(countryProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "country"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/contactpoint-country", "country"); if (e) errors.push(e) }
