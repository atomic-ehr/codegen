...
export type observation_heartrateProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"Patient">;
    category?: CodeableConcept<("social-history" | "vital-signs" | "imaging" | "laboratory" | "procedure" | "survey" | "exam" | "therapy" | "activity" | string)>[];
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/heartrate (pkg: hl7.fhir.r4.examples#4.0.1)
export class observation_heartrateProfile {
    ...
    static createResource (args: observation_heartrateProfileParams) : Observation {
    ...
    static create (args: observation_heartrateProfileParams) : observation_heartrateProfile {
        return observation_heartrateProfile.from(observation_heartrateProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "observation-heartrate"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "observation-heartrate"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "observation-heartrate"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "observation-heartrate.category"))
        { const e = validateRequired(r, "code", "observation-heartrate"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"code":"8867-4","system":"http://loinc.org"}]}, "observation-heartrate"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "observation-heartrate"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["Patient"], "subject", "observation-heartrate"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "hasMember", "observation-heartrate"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","Media","MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "derivedFrom", "observation-heartrate"); if (e) errors.push(e) }
        return errors
    }
