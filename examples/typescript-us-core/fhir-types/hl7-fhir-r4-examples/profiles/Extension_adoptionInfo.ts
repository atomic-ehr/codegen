...
export type adoptionInfoProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/patient-adoptionInfo (pkg: hl7.fhir.r4.examples#4.0.1)
export class adoptionInfoProfile {
    ...
    static createResource (args: adoptionInfoProfileParams) : Extension {
    ...
    static create (args: adoptionInfoProfileParams) : adoptionInfoProfile {
        return adoptionInfoProfile.from(adoptionInfoProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "adoptionInfo"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/patient-adoptionInfo", "adoptionInfo"); if (e) errors.push(e) }
