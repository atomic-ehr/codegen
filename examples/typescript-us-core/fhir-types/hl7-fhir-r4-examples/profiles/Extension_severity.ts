...
export type severityProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/familymemberhistory-severity (pkg: hl7.fhir.r4.examples#4.0.1)
export class severityProfile {
    ...
    static createResource (args: severityProfileParams) : Extension {
    ...
    static create (args: severityProfileParams) : severityProfile {
        return severityProfile.from(severityProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "severity"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/familymemberhistory-severity", "severity"); if (e) errors.push(e) }
