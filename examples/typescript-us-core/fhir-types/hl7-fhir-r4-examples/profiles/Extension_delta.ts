...
export type deltaProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/observation-delta (pkg: hl7.fhir.r4.examples#4.0.1)
export class deltaProfile {
    ...
    static createResource (args: deltaProfileParams) : Extension {
    ...
    static create (args: deltaProfileParams) : deltaProfile {
        return deltaProfile.from(deltaProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "delta"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/observation-delta", "delta"); if (e) errors.push(e) }
