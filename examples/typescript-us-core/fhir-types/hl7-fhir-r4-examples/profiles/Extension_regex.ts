...
export type regexProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/regex (pkg: hl7.fhir.r4.examples#4.0.1)
export class regexProfile {
    ...
    static createResource (args: regexProfileParams) : Extension {
    ...
    static create (args: regexProfileParams) : regexProfile {
        return regexProfile.from(regexProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "regex"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/regex", "regex"); if (e) errors.push(e) }
