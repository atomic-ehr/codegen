...
export type ValidityPeriodProfileParams = {
    valueDateTime: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/cqm-ValidityPeriod (pkg: hl7.fhir.r4.examples#4.0.1)
export class ValidityPeriodProfile {
    ...
    static createResource (args: ValidityPeriodProfileParams) : Extension {
    ...
    static create (args: ValidityPeriodProfileParams) : ValidityPeriodProfile {
        return ValidityPeriodProfile.from(ValidityPeriodProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "ValidityPeriod"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/cqm-ValidityPeriod", "ValidityPeriod"); if (e) errors.push(e) }
