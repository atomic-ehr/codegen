...
export type reasonCodeProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/workflow-reasonCode (pkg: hl7.fhir.r4.examples#4.0.1)
export class reasonCodeProfile {
    ...
    static createResource (args: reasonCodeProfileParams) : Extension {
    ...
    static create (args: reasonCodeProfileParams) : reasonCodeProfile {
        return reasonCodeProfile.from(reasonCodeProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "reasonCode"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/workflow-reasonCode", "reasonCode"); if (e) errors.push(e) }
