...
export type partOfProfileParams = {
    valueReference: Reference;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/event-partOf (pkg: hl7.fhir.r4.examples#4.0.1)
export class partOfProfile {
    ...
    static createResource (args: partOfProfileParams) : Extension {
    ...
    static create (args: partOfProfileParams) : partOfProfile {
        return partOfProfile.from(partOfProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/event-partOf", "partOf"); if (e) errors.push(e) }
