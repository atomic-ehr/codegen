...
export type observation_headcircumProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"Patient">;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/headcircum (pkg: hl7.fhir.r4.examples#4.0.1)
export class observation_headcircumProfile {
    ...
    static createResource (args: observation_headcircumProfileParams) : Observation {
    ...
    static create (args: observation_headcircumProfileParams) : observation_headcircumProfile {
        return observation_headcircumProfile.from(observation_headcircumProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "observation-headcircum"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "observation-headcircum"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "observation-headcircum"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "observation-headcircum.category"))
        { const e = validateRequired(r, "code", "observation-headcircum"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"code":"9843-4","system":"http://loinc.org"}]}, "observation-headcircum"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "observation-headcircum"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["Patient"], "subject", "observation-headcircum"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "hasMember", "observation-headcircum"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","Media","MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "derivedFrom", "observation-headcircum"); if (e) errors.push(e) }
        return errors
    }
