...
export type styleProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/rendering-style (pkg: hl7.fhir.r4.examples#4.0.1)
export class styleProfile {
    ...
    static createResource (args: styleProfileParams) : Extension {
    ...
    static create (args: styleProfileParams) : styleProfile {
        return styleProfile.from(styleProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "style"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/rendering-style", "style"); if (e) errors.push(e) }
