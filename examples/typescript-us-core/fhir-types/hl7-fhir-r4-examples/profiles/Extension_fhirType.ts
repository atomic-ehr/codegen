...
export type fhirTypeProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/questionnaire-fhirType (pkg: hl7.fhir.r4.examples#4.0.1)
export class fhirTypeProfile {
    ...
    static createResource (args: fhirTypeProfileParams) : Extension {
    ...
    static create (args: fhirTypeProfileParams) : fhirTypeProfile {
        return fhirTypeProfile.from(fhirTypeProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "fhirType"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/questionnaire-fhirType", "fhirType"); if (e) errors.push(e) }
