...
export type locationProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/openEHR-location (pkg: hl7.fhir.r4.examples#4.0.1)
export class locationProfile {
    ...
    static createResource (args: locationProfileParams) : Extension {
    ...
    static create (args: locationProfileParams) : locationProfile {
        return locationProfile.from(locationProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "location"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/openEHR-location", "location"); if (e) errors.push(e) }
