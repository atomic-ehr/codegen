...
export type systemNameProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/valueset-systemName (pkg: hl7.fhir.r4.examples#4.0.1)
export class systemNameProfile {
    ...
    static createResource (args: systemNameProfileParams) : Extension {
    ...
    static create (args: systemNameProfileParams) : systemNameProfile {
        return systemNameProfile.from(systemNameProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "systemName"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/valueset-systemName", "systemName"); if (e) errors.push(e) }
