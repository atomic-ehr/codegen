...
export type typeProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/familymemberhistory-type (pkg: hl7.fhir.r4.examples#4.0.1)
export class typeProfile {
    ...
    static createResource (args: typeProfileParams) : Extension {
    ...
    static create (args: typeProfileParams) : typeProfile {
        return typeProfile.from(typeProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "type"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/familymemberhistory-type", "type"); if (e) errors.push(e) }
