...
export type testProfileParams = {
    valueReference: Reference;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/openEHR-test (pkg: hl7.fhir.r4.examples#4.0.1)
export class testProfile {
    ...
    static createResource (args: testProfileParams) : Extension {
    ...
    static create (args: testProfileParams) : testProfile {
        return testProfile.from(testProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "test"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/openEHR-test", "test"); if (e) errors.push(e) }
