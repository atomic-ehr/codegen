...
export type areaProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/contactpoint-area (pkg: hl7.fhir.r4.examples#4.0.1)
export class areaProfile {
    ...
    static createResource (args: areaProfileParams) : Extension {
    ...
    static create (args: areaProfileParams) : areaProfile {
        return areaProfile.from(areaProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "area"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/contactpoint-area", "area"); if (e) errors.push(e) }
