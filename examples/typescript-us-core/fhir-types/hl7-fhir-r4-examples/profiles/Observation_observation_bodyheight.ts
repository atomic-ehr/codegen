...
export type observation_bodyheightProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"Patient">;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/bodyheight (pkg: hl7.fhir.r4.examples#4.0.1)
export class observation_bodyheightProfile {
    ...
    static createResource (args: observation_bodyheightProfileParams) : Observation {
    ...
    static create (args: observation_bodyheightProfileParams) : observation_bodyheightProfile {
        return observation_bodyheightProfile.from(observation_bodyheightProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "observation-bodyheight"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "observation-bodyheight"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "observation-bodyheight"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "observation-bodyheight.category"))
        { const e = validateRequired(r, "code", "observation-bodyheight"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"code":"8302-2","system":"http://loinc.org"}]}, "observation-bodyheight"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "observation-bodyheight"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["Patient"], "subject", "observation-bodyheight"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "hasMember", "observation-bodyheight"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","Media","MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "derivedFrom", "observation-bodyheight"); if (e) errors.push(e) }
        return errors
    }
