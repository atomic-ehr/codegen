...
export type InterpretationProfileParams = {
    valueReference: Reference;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/observation-geneticsInterpretation (pkg: hl7.fhir.r4.examples#4.0.1)
export class InterpretationProfile {
    ...
    static createResource (args: InterpretationProfileParams) : Extension {
    ...
    static create (args: InterpretationProfileParams) : InterpretationProfile {
        return InterpretationProfile.from(InterpretationProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "Interpretation"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/observation-geneticsInterpretation", "Interpretation"); if (e) errors.push(e) }
