...
export type focusCodeProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/observation-focusCode (pkg: hl7.fhir.r4.examples#4.0.1)
export class focusCodeProfile {
    ...
    static createResource (args: focusCodeProfileParams) : Extension {
    ...
    static create (args: focusCodeProfileParams) : focusCodeProfile {
        return focusCodeProfile.from(focusCodeProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "focusCode"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/observation-focusCode", "focusCode"); if (e) errors.push(e) }
