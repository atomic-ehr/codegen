...
export type disabilityProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/patient-disability (pkg: hl7.fhir.r4.examples#4.0.1)
export class disabilityProfile {
    ...
    static createResource (args: disabilityProfileParams) : Extension {
    ...
    static create (args: disabilityProfileParams) : disabilityProfile {
        return disabilityProfile.from(disabilityProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "disability"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/patient-disability", "disability"); if (e) errors.push(e) }
