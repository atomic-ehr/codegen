...
export type congregationProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/patient-congregation (pkg: hl7.fhir.r4.examples#4.0.1)
export class congregationProfile {
    ...
    static createResource (args: congregationProfileParams) : Extension {
    ...
    static create (args: congregationProfileParams) : congregationProfile {
        return congregationProfile.from(congregationProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "congregation"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/patient-congregation", "congregation"); if (e) errors.push(e) }
