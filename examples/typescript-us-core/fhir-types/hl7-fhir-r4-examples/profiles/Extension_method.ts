...
export type methodProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/procedure-method (pkg: hl7.fhir.r4.examples#4.0.1)
export class methodProfile {
    ...
    static createResource (args: methodProfileParams) : Extension {
    ...
    static create (args: methodProfileParams) : methodProfile {
        return methodProfile.from(methodProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "method"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/procedure-method", "method"); if (e) errors.push(e) }
