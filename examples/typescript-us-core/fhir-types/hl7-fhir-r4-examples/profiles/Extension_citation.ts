...
export type citationProfileParams = {
    valueString: string;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/cqf-citation (pkg: hl7.fhir.r4.examples#4.0.1)
export class citationProfile {
    ...
    static createResource (args: citationProfileParams) : Extension {
    ...
    static create (args: citationProfileParams) : citationProfile {
        return citationProfile.from(citationProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "citation"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/cqf-citation", "citation"); if (e) errors.push(e) }
