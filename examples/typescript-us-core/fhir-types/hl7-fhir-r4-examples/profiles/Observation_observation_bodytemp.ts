...
export type observation_bodytempProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"Patient">;
    category?: CodeableConcept<("social-history" | "vital-signs" | "imaging" | "laboratory" | "procedure" | "survey" | "exam" | "therapy" | "activity" | string)>[];
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/bodytemp (pkg: hl7.fhir.r4.examples#4.0.1)
export class observation_bodytempProfile {
    ...
    static createResource (args: observation_bodytempProfileParams) : Observation {
    ...
    static create (args: observation_bodytempProfileParams) : observation_bodytempProfile {
        return observation_bodytempProfile.from(observation_bodytempProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "observation-bodytemp"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "observation-bodytemp"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "observation-bodytemp"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "observation-bodytemp.category"))
        { const e = validateRequired(r, "code", "observation-bodytemp"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"code":"8310-5","system":"http://loinc.org"}]}, "observation-bodytemp"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "observation-bodytemp"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["Patient"], "subject", "observation-bodytemp"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "hasMember", "observation-bodytemp"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","Media","MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "derivedFrom", "observation-bodytemp"); if (e) errors.push(e) }
        return errors
    }
