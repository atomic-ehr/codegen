...
export type observation_oxygensatProfileParams = {
    status: ("registered" | "preliminary" | "final" | "amended" | "corrected" | "cancelled" | "entered-in-error" | "unknown");
    subject: Reference<"Patient">;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/oxygensat (pkg: hl7.fhir.r4.examples#4.0.1)
export class observation_oxygensatProfile {
    ...
    static createResource (args: observation_oxygensatProfileParams) : Observation {
    ...
    static create (args: observation_oxygensatProfileParams) : observation_oxygensatProfile {
        return observation_oxygensatProfile.from(observation_oxygensatProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "status", "observation-oxygensat"); if (e) errors.push(e) }
        { const e = validateEnum(r["status"], ["registered","preliminary","final","amended","corrected","cancelled","entered-in-error","unknown"], "status", "observation-oxygensat"); if (e) errors.push(e) }
        { const e = validateRequired(r, "category", "observation-oxygensat"); if (e) errors.push(e) }
        errors.push(...validateSliceCardinality(r["category"] as unknown[] | undefined, {"coding":{"code":"vital-signs","system":"http://terminology.hl7.org/CodeSystem/observation-category"}}, "VSCat", 1, 1, "observation-oxygensat.category"))
        { const e = validateRequired(r, "code", "observation-oxygensat"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "code", {"coding":[{"code":"2708-6","system":"http://loinc.org"}]}, "observation-oxygensat"); if (e) errors.push(e) }
        { const e = validateRequired(r, "subject", "observation-oxygensat"); if (e) errors.push(e) }
        { const e = validateReference(r["subject"], ["Patient"], "subject", "observation-oxygensat"); if (e) errors.push(e) }
        ...
        { const e = validateReference(r["hasMember"], ["MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "hasMember", "observation-oxygensat"); if (e) errors.push(e) }
        { const e = validateReference(r["derivedFrom"], ["DocumentReference","ImagingStudy","Media","MolecularSequence","QuestionnaireResponse","observation-vitalsigns"], "derivedFrom", "observation-oxygensat"); if (e) errors.push(e) }
        return errors
    }
