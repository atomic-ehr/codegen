...
export type insuranceProfileParams = {
    valueReference: Reference;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/request-insurance (pkg: hl7.fhir.r4.examples#4.0.1)
export class insuranceProfile {
    ...
    static createResource (args: insuranceProfileParams) : Extension {
    ...
    static create (args: insuranceProfileParams) : insuranceProfile {
        return insuranceProfile.from(insuranceProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "insurance"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/request-insurance", "insurance"); if (e) errors.push(e) }
