...
export type importanceProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/patient-importance (pkg: hl7.fhir.r4.examples#4.0.1)
export class importanceProfile {
    ...
    static createResource (args: importanceProfileParams) : Extension {
    ...
    static create (args: importanceProfileParams) : importanceProfile {
        return importanceProfile.from(importanceProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "importance"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/patient-importance", "importance"); if (e) errors.push(e) }
