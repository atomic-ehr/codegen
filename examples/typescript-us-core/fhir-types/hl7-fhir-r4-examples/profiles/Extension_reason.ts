...
export type reasonProfileParams = {
    valueCodeableConcept: CodeableConcept;
}

// CanonicalURL: http://hl7.org/fhir/StructureDefinition/questionnaireresponse-reason (pkg: hl7.fhir.r4.examples#4.0.1)
export class reasonProfile {
    ...
    static createResource (args: reasonProfileParams) : Extension {
    ...
    static create (args: reasonProfileParams) : reasonProfile {
        return reasonProfile.from(reasonProfile.createResource(args))
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "url", "reason"); if (e) errors.push(e) }
        { const e = validateFixedValue(r, "url", "http://hl7.org/fhir/StructureDefinition/questionnaireresponse-reason", "reason"); if (e) errors.push(e) }
