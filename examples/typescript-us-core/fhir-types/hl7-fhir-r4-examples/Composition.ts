...
import type { Narrative } from "../hl7-fhir-r4-examples/Narrative";
...
export type { Narrative } from "../hl7-fhir-r4-examples/Narrative";
...
// CanonicalURL: http://hl7.org/fhir/StructureDefinition/Composition (pkg: hl7.fhir.r4.examples#4.0.1)
