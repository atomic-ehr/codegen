...
export type UserAccessBrandProfileParams = {
    name: string;
    telecom: ContactPoint[];
}

// CanonicalURL: http://hl7.org/fhir/smart-app-launch/StructureDefinition/user-access-brand (pkg: hl7.fhir.uv.smart-app-launch#2.2.0)
export class UserAccessBrandProfile {
    static readonly canonicalUrl = "http://hl7.org/fhir/smart-app-launch/StructureDefinition/user-access-brand"
    ...
    constructor (resource: Organization) {
        ...
        if (!profiles.includes("http://hl7.org/fhir/smart-app-launch/StructureDefinition/user-access-brand")) profiles.push("http://hl7.org/fhir/smart-app-launch/StructureDefinition/user-access-brand")
    }

    static from (resource: Organization) : UserAccessBrandProfile {
        return new UserAccessBrandProfile(resource)
    }

    static createResource (args: UserAccessBrandProfileParams) : Organization {
        const resource: Organization = {
            resourceType: "Organization",
            name: args.name,
            telecom: args.telecom,
            meta: { profile: ["http://hl7.org/fhir/smart-app-launch/StructureDefinition/user-access-brand"] },
        } as unknown as Organization
        return resource
    }

    static create (args: UserAccessBrandProfileParams) : UserAccessBrandProfile {
        return UserAccessBrandProfile.from(UserAccessBrandProfile.createResource(args))
    }
    ...
    getTelecom () : ContactPoint[] | undefined {
        return this.resource.telecom as ContactPoint[] | undefined
    }

    setTelecom (value: ContactPoint[]) : this {
        Object.assign(this.resource, { telecom: value })
        return this
    }
    ...
    validate () : string[] {
        ...
        { const e = validateRequired(r, "name", "UserAccessBrand"); if (e) errors.push(e) }
        { const e = validateRequired(r, "telecom", "UserAccessBrand"); if (e) errors.push(e) }
        { const e = validateReference(r["partOf"], ["Organization"], "partOf", "UserAccessBrand"); if (e) errors.push(e) }
        { const e = validateReference(r["endpoint"], ["UserAccessEndpoint"], "endpoint", "UserAccessBrand"); if (e) errors.push(e) }
        return errors
    }
