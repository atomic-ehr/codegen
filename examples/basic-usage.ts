    ...
    try {
        ...
        switch (example) {
            ...
            default:
                ...
                console.log("  bun run examples/basic-usage.ts basic      - Generate basic FHIR R4 types");
                console.log("  bun run examples/basic-usage.ts us-core    - Generate US Core types");
                console.log("  bun run examples/basic-usage.ts custom     - Generate custom profile types");
                console.log("  bun run examples/basic-usage.ts selective  - Generate selected resources");
                console.log("  bun run examples/basic-usage.ts usage      - Demonstrate type usage");
                console.log("  bun run examples/basic-usage.ts advanced   - Advanced configuration");
                console.log("  bun run examples/basic-usage.ts multi      - Multi-package generation");
                console.log("  bun run examples/basic-usage.ts validation - Generate with validation");
                console.log("  bun run examples/basic-usage.ts all        - Run all examples");
        }
...
export { generateBasicFHIRTypes, generateUSCoreTypes, demonstrateGeneratedTypes };
