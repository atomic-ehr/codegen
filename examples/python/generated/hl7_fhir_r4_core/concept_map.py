...
class ConceptMapGroupElementTarget(BackboneElement):
    ...
    display: str | None = Field(None, alias="display", serialization_alias="display")
    equivalence: Literal["relatedto", "equivalent", "equal", "wider", "subsumes", "narrower", "specializes", "inexact", "unmatched", "disjoint"] = Field(alias="equivalence", serialization_alias="equivalence")
