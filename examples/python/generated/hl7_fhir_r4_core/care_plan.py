...
class CarePlanActivityDetail(BackboneElement):
    ...
    status: Literal["not-started", "scheduled", "in-progress", "on-hold", "completed", "cancelled", "stopped", "unknown", "entered-in-error"] = Field(alias="status", serialization_alias="status")
