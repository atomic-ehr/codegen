...
class Goal(DomainResource):
    ...
    lifecycle_status: Literal["proposed", "planned", "accepted", "active", "on-hold", "completed", "cancelled", "entered-in-error", "rejected"] = Field(alias="lifecycleStatus", serialization_alias="lifecycleStatus")
