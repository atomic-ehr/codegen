...
- `urn:fhir:binding:ObservationRangeMeaning` (2 versions)
  - Version 1 (selected): Observation (hl7.fhir.r4.core#4.0.1), cholesterol (hl7.fhir.r4.core#4.0.1), hdlcholesterol (hl7.fhir.r4.core#4.0.1), ldlcholesterol (hl7.fhir.r4.core#4.0.1), triglyceride (hl7.fhir.r4.core#4.0.1)
  - Version 2: ObservationDefinition (hl7.fhir.r4.core#4.0.1)
