...
export const attach_observation_bp = (resource: Observation, profile: observation_bp): Observation => {
    return {
        ...resource,
        meta: {
...
export const extract_Observation = (resource: Observation): observation_bp => {
