...
export const attach_observation_bodytemp = (resource: Observation, profile: observation_bodytemp): Observation => {
    return {
        ...resource,
        meta: {
...
export const extract_Observation = (resource: Observation): observation_bodytemp => {
