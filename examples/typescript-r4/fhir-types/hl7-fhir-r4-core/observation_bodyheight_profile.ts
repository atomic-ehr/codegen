...
export const attach_observation_bodyheight = (resource: Observation, profile: observation_bodyheight): Observation => {
    return {
        ...resource,
        meta: {
...
export const extract_Observation = (resource: Observation): observation_bodyheight => {
