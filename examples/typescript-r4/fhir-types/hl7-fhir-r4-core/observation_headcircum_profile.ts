...
export const attach_observation_headcircum = (resource: Observation, profile: observation_headcircum): Observation => {
    return {
        ...resource,
        meta: {
...
export const extract_Observation = (resource: Observation): observation_headcircum => {
