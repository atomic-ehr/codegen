import { type Log, type LogManager, type LoggerOptions, mkLogger } from "./log";
...
export const mkCodegenLogger = <T extends string = CodegenTag>(opts: LoggerOptions<T> = {}) => mkLogger<T>(opts);
