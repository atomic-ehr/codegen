...
export interface TypeSchemaForResourceComplexLogical {
  ...
  identifier: (TypeSchemaIdentifierBase & WithResourceKind) | 
              (TypeSchemaIdentifierBase & WithComplexTypeKind) | 
              (TypeSchemaIdentifierBase & WithLogicalKind);
...
export function isPrimitiveTypeSchema(schema: TypeSchema): schema is TypeSchemaForPrimitiveType {
  return schema.identifier.kind === "primitive-type";
}

export function isResourceSchema(schema: TypeSchema): schema is TypeSchemaForResourceComplexLogical {
  return schema.identifier.kind === "resource";
}

export function isComplexTypeSchema(schema: TypeSchema): schema is TypeSchemaForResourceComplexLogical {
  return schema.identifier.kind === "complex-type";
}

export function isLogicalSchema(schema: TypeSchema): schema is TypeSchemaForResourceComplexLogical {
  return schema.identifier.kind === "logical";
}

export function isValueSetSchema(schema: TypeSchema): schema is TypeSchemaForValueSet {
...
export function isNestedTypeSchema(identifier: TypeSchemaIdentifier): identifier is TypeSchemaIdentifierBase & WithNestedKind {
...
export function isPolymorphicDeclarationField(field: TypeSchemaField): field is PolymorphicDeclarationField {
  return 'choices' in field;
}

export function isPolymorphicInstanceField(field: TypeSchemaField): field is PolymorphicInstanceField {
...
export type ExtractFieldType<T extends TypeSchema, F extends string> =
  T extends TypeSchemaForResourceComplexLogical
    ? T['fields'] extends Record<string, any>
