// import type { MustacheGenerator, MustacheGeneratorOptions } from "./generator/MustacheGenerator";
// import path from "node:path";
// import type { GeneratorOptions } from "@fscg/generators/generator";
...
// type FileBasedMustacheGeneratorOptions = Pick<
//     MustacheGeneratorOptions,
//     "debug" | "renderings" | "typeMap" | "filters" | "meta" | "hooks" | "nameTransformations" | "unsaveCharacterPattern"
// > & {
//     keywords?: string[];
// };
...
//     const optionsFromFile: FileBasedMustacheGeneratorOptions = loadJsonFile(
//         path.resolve(sourceDir, "config.json"),
//         DEFAULT_FILE_BASED_MUSTACHE_GENERATOR_OPTIONS,
//     );
//     const mustacheOptions: MustacheGeneratorOptions = {
//         ...options,
//         debug:
//             optionsFromFile.debug !== undefined
//                 ? optionsFromFile.debug
//                 : DEFAULT_FILE_BASED_MUSTACHE_GENERATOR_OPTIONS.debug,
//         unsaveCharacterPattern:
//             optionsFromFile.unsaveCharacterPattern ??
//             DEFAULT_FILE_BASED_MUSTACHE_GENERATOR_OPTIONS.unsaveCharacterPattern,
//         meta: {
