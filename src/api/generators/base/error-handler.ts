...
import { GeneratorError, BatchOperationError } from './errors';
...
export class ErrorHandler {
   ...
   */
  private handleGeneratorError(error: GeneratorError, context?: { schema?: TypeSchema; filename?: string }): void {
...
export class GeneratorErrorBoundary {
  ...
  async withErrorBoundary<T>(
    operation: () => Promise<T>,
    context?: { schema?: TypeSchema; filename?: string; operationName?: string }
  ): Promise<T> {
    try {
