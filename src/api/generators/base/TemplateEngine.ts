...
export abstract class TemplateEngine {
    ...
    protected registerDefaultHelpers(): void {
        ...
        this.registerHelper("capitalize", (str: string) => str.charAt(0).toUpperCase() + str.slice(1));

        this.registerHelper("lowercase", (str: string) => str.toLowerCase());
        this.registerHelper("uppercase", (str: string) => str.toUpperCase());

        this.registerHelper("camelCase", (str: string) => str.replace(/[-_\s]+(.)/g, (_, char) => char.toUpperCase()));
        ...
        // Array helpers
        this.registerHelper("join", (arr: any[], separator = ", ") => (Array.isArray(arr) ? arr.join(separator) : ""));
