...
describe("TypeSchema Transformer Core Logic", () => {
  ...
  describe("transformFHIRSchema", () => {
    it("should transform a basic resource schema", async () => {
      ...
      const result = await transformFHIRSchema(fhirSchema, mockManager as any, basePackageInfo);
    ...
    it("should transform primitive type schema", async () => {
      ...
      const result = await transformFHIRSchema(fhirSchema, mockManager as any);
    ...
    it("should handle extension schemas", async () => {
      const fhirSchema: FHIRSchema = {
        ...
        elements: {
          url: { type: "uri", fixed: "http://example.org/extensions/patient-extension" },
          value: { type: "string" },
        },
      };
    ...
    it("should preserve package information", async () => {
      ...
      const result = await transformFHIRSchema(fhirSchema, mockManager as any, customPackageInfo);
