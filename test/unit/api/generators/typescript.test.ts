...
import type { TypeSchema, TypeSchemaIdentifier } from "../../../../src/typeschema/types";
  ...
  describe("TypeScriptAPIGenerator.transformSchema", () => {
    it("should transform basic resource schema to TypeScript", async () => {
      const schema: TypeSchema = {
        ...
        fields: {
          id: { type: { kind: "primitive-type", name: "id", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" } },
          name: { type: { kind: "complex-type", name: "HumanName", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" }, array: true },
        },
        dependencies: [],
      };
    ...
    it("should handle complex type with base interface", async () => {
      const schema: TypeSchema = {
        ...
        fields: {
          use: { type: { kind: "primitive-type", name: "code", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" } },
          line: { type: { kind: "primitive-type", name: "string", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" }, array: true },
        },
        dependencies: [],
      };
      ...
      expect(result).toBeDefined();
      expect(result?.content).toContain("export interface Address extends Element");
    ...
    it("should handle Reference type with generics", async () => {
      const schema: TypeSchema = {
        ...
        fields: {
          type: { type: { kind: "primitive-type", name: "string", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" } },
          reference: { type: { kind: "primitive-type", name: "string", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" } },
        },
        dependencies: [],
      };
      ...
      expect(result).toBeDefined();
      expect(result?.content).toContain("Reference<T extends ResourceTypes = ResourceTypes>");
    ...
    it("should handle optional fields correctly", async () => {
      const schema: TypeSchema = {
        ...
        fields: {
          requiredField: { type: { kind: "primitive-type", name: "string", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" }, required: true },
          optionalField: { type: { kind: "primitive-type", name: "string", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" }, required: false },
        },
        dependencies: [],
      };
    ...
    it("should handle array fields", async () => {
      const schema: TypeSchema = {
        ...
        fields: {
          items: { type: { kind: "primitive-type", name: "string", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" }, array: true },
          singleItem: { type: { kind: "primitive-type", name: "string", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" }, array: false },
        },
        dependencies: [],
      };
    ...
    it("should handle enum fields with small sets", async () => {
      ...
      expect(result).toBeDefined();
      expect(result?.content).toContain("status: 'active' | 'inactive' | 'pending'");
    });
    ...
    it("should handle nested types", async () => {
      const schema: TypeSchema = {
        ...
        fields: {
          nested: { type: { kind: "nested", name: "NestedType", package: "test", version: "1.0.0", url: "" } },
        },
        nested: [{
          identifier: {
            kind: "nested",
          ...
          fields: {
            value: { type: { kind: "primitive-type", name: "string", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" } },
          },
        }],
        dependencies: [],
      };
      ...
      expect(result?.content).toContain("export interface ParentTypeNestedType");
    ...
    it("should handle reference fields with specific targets", async () => {
      const schema: TypeSchema = {
        ...
        fields: {
          subject: {
            reference: [
              { kind: "resource", name: "Patient", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" },
              { kind: "resource", name: "Group", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" },
            ],
          },
        },
        dependencies: [],
      ...
      const schema: TypeSchema = {
        ...
        fields: {
          value: {
            polymorphic: true,
            types: [
              { kind: "complex-type", name: "Quantity", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" },
              { kind: "primitive-type", name: "string", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" },
              { kind: "primitive-type", name: "boolean", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" },
            ],
          },
        },
        dependencies: [],
    ...
    it("should track resource types for ResourceTypes union", async () => {
      ...
      expect(utilityFile?.content).toContain("ResourceTypes = 'Patient' | 'Observation'");
    });
    ...
    it("should handle primitive type mapping", async () => {
      const schema: TypeSchema = {
        ...
        fields: {
          stringField: { type: { kind: "primitive-type", name: "string", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" } },
          integerField: { type: { kind: "primitive-type", name: "integer", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" } },
          booleanField: { type: { kind: "primitive-type", name: "boolean", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" } },
          dateField: { type: { kind: "primitive-type", name: "date", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" } },
          decimalField: { type: { kind: "primitive-type", name: "decimal", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" } },
        },
        dependencies: [],
      };
    ...
    it("should generate correct imports for complex types", async () => {
      const schema: TypeSchema = {
        ...
        fields: {
          name: { type: { kind: "complex-type", name: "HumanName", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" }, array: true },
          address: { type: { kind: "complex-type", name: "Address", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" }, array: true },
          identifier: { type: { kind: "complex-type", name: "Identifier", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" }, array: true },
        },
        dependencies: [],
      };
    ...
    it("should handle binding fields", async () => {
      const schema: TypeSchema = {
        ...
        fields: {
          status: {
            type: { kind: "primitive-type", name: "code", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" },
            binding: {
              kind: "value-set",
              name: "StatusValueSet",
              package: "test",
    ...
    it("should handle circular dependencies gracefully", async () => {
      const schema: TypeSchema = {
        ...
        fields: {
          parent: { type: { kind: "complex-type", name: "CircularType", package: "test", version: "1.0.0", url: "http://example.org/CircularType" } },
          children: { type: { kind: "complex-type", name: "CircularType", package: "test", version: "1.0.0", url: "http://example.org/CircularType" }, array: true },
        },
        dependencies: [],
      };
    ...
    it("should handle mixed field types in one schema", async () => {
      const schema: TypeSchema = {
        ...
        fields: {
          simpleString: { type: { kind: "primitive-type", name: "string", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" } },
          enumField: { enum: ["a", "b", "c"] },
          complexField: { type: { kind: "complex-type", name: "Address", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" } },
          arrayField: { type: { kind: "primitive-type", name: "integer", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" }, array: true },
          requiredField: { type: { kind: "primitive-type", name: "boolean", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" }, required: true },
          referenceField: {
            reference: [
              { kind: "resource", name: "Patient", package: "hl7.fhir.r4.core", version: "4.0.1", url: "" },
            ],
      ...
      expect(result?.content).toContain("referenceField?: Reference<'Patient'>");
    });
  });
